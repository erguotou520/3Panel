...
import (
	...
	"github.com/3panel-dev/3panel/agent/utils/firewall/lifecycle/providers"
)

const fail2BanRestoreWithFirewallMarker = "/run/3panel_fail2ban_restore_with_firewall"
