...
const (
	...
	ChainPreRouting  = "3PANEL_PREROUTING"
	ChainPostRouting = "3PANEL_POSTROUTING"
	ChainForward     = "3PANEL_FORWARD"

	ForwardFile     = "3panel_forward.rules"
	PreRoutingFile  = "3panel_forward_pre.rules"
	PostRoutingFile = "3panel_forward_post.rules"
)
