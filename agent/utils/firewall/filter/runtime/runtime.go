...
import (
	...
	filterfirewalld "github.com/3panel-dev/3panel/agent/utils/firewall/filter/providers/firewalld"
	filteriptables "github.com/3panel-dev/3panel/agent/utils/firewall/filter/providers/iptables"
	filternftables "github.com/3panel-dev/3panel/agent/utils/firewall/filter/providers/nftables"
...
func (e *Engine) CompileDesired(
	...
	for ordinal, rule := range rules {
		...
		if capabilities.Marker {
			desired.Marker = "3panel-rule:" + prepared.UUID
		}
