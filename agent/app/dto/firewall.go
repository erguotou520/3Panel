...
type FilterChainOperation struct {
	Name    string `json:"name" validate:"required,eq=3PANEL_BASIC"`
...
type FirewallRuleInventory struct {
	...
	ExcludeChains []string                `json:"excludeChains,omitempty" validate:"omitempty,dive,oneof=3PANEL_BASIC_BEFORE 3PANEL_BASIC 3PANEL_BASIC_AFTER"`
}
