...
const (
	// nginxHTTPConfDir holds http-context directives generated by 3Panel.
	...
	nginxHTTPConfigPrefix = "3panel-http-"
	nginxHTTPConfigHeader = "# Managed by 3Panel. Manual changes will be overwritten.\n"
