...
const message = {
    ...
    database: {
        ...
        supplementPasswordHelper: 'This only saves the existing password to 3Panel and does not change it in MySQL.',
        ...
        loadFromRemoteHelper: 'Sync databases, users, and authorizations from the server to 3Panel. Continue?',
    ...
    aiTools: {
        agents: {
            ...
            modelMetadata: 'Model Capabilities',
            modelMetadataHelper:
                'These settings apply only to this OpenClaw instance. Leave values empty to use OpenClaw or provider defaults.',
            inputModeAuto: 'Auto detect',
            inputModeText: 'Text only',
            inputModeImage: 'Text and images',
        ...
        model: {
            ...
            from_remote: 'This model was not downloaded via 3Panel, no related pull logs.',
        ...
        benchmark: {
            ...
            tokenizerPlaceholder:
                'Select or enter a local tokenizer directory, e.g. /opt/3panel/tokenizers/DeepSeek-V3',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Arguments are appended to the supergateway command. Transport, port, path, and protocol arguments managed by 3Panel cannot be changed',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Detected that the container is from the App Store. Deleting the container will not completely remove it from 3Panel. To delete it completely, go to the App Store -> 'Installed' or 'Runtime Environment' menus. Continue?",
        start: 'Start',
        stop: 'Stop',
        restart: 'Restart',
        kill: 'Kill',
        ...
        composeHelper:
            'The composition created through 3Panel editor or template will be saved in the {0}/docker/compose directory.',
        ...
        running: 'Running ( {0} / {1} )',
        composeDetailHelper:
            'The compose is created external to 3Panel. The start and stop operations are not supported.',
        ...
        composeEnvHelper2:
            'This orchestration was created by the 3Panel App Store. Please modify environment variables in the installed applications.',
    ...
    cronjob: {
        ...
        logHelper1: '1. 3Panel system log',
        ...
        cutWebsiteLogHelper: 'The rotated log files will be backed up to the backup directory of 3Panel.',
    ...
    file: {
        ...
        clashDidNotSupport: 'File names are prohibited from containing .3panel_clash',
        ...
        panelInstallDir: "3Panel installation directory can't be deleted",
    ...
    setting: {
        ...
        timeZoneHelper:
            'Timezone modification depends on the system timedatectl service. take effect after restart the 3Panel service.',
        timeZoneCN: 'Bei Jing',
        timeZoneAM: 'Los Angeles',
        timeZoneNY: 'New York',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: '3Panel domain binding configured',
        ...
        bindDomainHelper: 'After you bind the domain, only that domain can access 3Panel service.',
        bindDomainHelper1: 'Leave it blank to disable the domain name binding.',
        bindDomainWarning:
            'After domain binding, you will be logged out and can only access 3Panel service through the domain name specified in the settings. Continue?',
        ...
        mfaTitleHelper:
            'The title is used to distinguish different 3Panel hosts. Scan again or manually add the secret key after you modify the title.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'This rule will be used to compress and backup the 3Panel data directory during creating snapshot. By default, socket files are ignored.',
        ignoreHelper1: 'One per line. For example,\n*.log\n/opt/3panel/cache',
        panelInfo: 'Write 3Panel basic information',
        panelBin: 'Backup 3Panel system files',
        daemonJson: 'Backup Docker configuration file',
        appData: 'Backup installed apps from 3Panel',
        panelData: 'Backup 3Panel data directory',
        backupData: 'Backup local backup directory for 3Panel',
        ...
        recoverHelper1: 'Recovery requires restarting Docker and 3Panel services',
        recoverHelper2:
        ...
        rollback: 'Rollback',
        rollbackHelper:
            'Rolling back this recovery will replace all files from this recovery, and may require restarting Docker and 3Panel services. Continue?',
        upgradeRecord: 'Upgrade record',
        upgrading: 'Upgrading, please wait...',
        upgradeHelper: 'The upgrade requires restarting the 3Panel service. Continue?',
        ...
        rollbackLocalHelper:
            'The primary node does not support direct rollback. Please manually execute the [3pctl restore] command to rollback!',
    ...
    license: {
        ...
        vm: 'Upgrade to the commercial edition to manage virtual machines, images, templates, virtual networks, and storage resources in 3Panel.',
        node: 'Upgrade to Commercial Edition to manage multiple Linux servers in 3Panel.',
    ...
    clean: {
        scan: 'Start scanning',
        scanHelper: 'Easily clean up junk files produced during 3Panel runtime',
        clean: 'Clean now',
        reScan: 'Rescan',
    ...
    ssl: {
        ...
        shellHelper:
            'The default execution directory of the script is the 3Panel installation directory. If a certificate is pushed into local directory, the execution directory will be the certificate push directory. The default execution timeout is 30 minutes.',
    ...
    firewall: {
        ...
        managedHelper: 'Created and managed by 3Panel.',
        adopted: 'Externally managed',
        adoptedHelper: 'An existing system rule now managed by 3Panel.',
        external: 'External rule',
        externalHelper: 'Not managed by 3Panel.',
        ...
        adoptRuleConfirm: 'After takeover, 3Panel can maintain and delete this existing rule. Continue?',
        ...
        plan_managed_rule_drifted:
            'The 3Panel management record differs from the live firewall rule. Check the system rule.',
        ...
        scopeUnmanagedActive: 'Other active scopes were detected: {0}. 3Panel will not modify their rules.',
        ...
        dockerFirewallHelper: 'Selects how 3Panel manages container port protection.',
        ...
        ruleSyncDatabase: '3Panel database',
        ruleSyncDatabaseHelper:
            'Synchronize and reconcile the managed rules in the current firewall based on the 3Panel database rules. Missing rules will be added and extra rules will be removed.',
        ...
        resetDirectRulesHelper:
            'Delete all 3Panel system firewall chains, runtime rules, and persisted files from {0}; saved database policies are retained',
        ...
        cleanupForwardingBackendHelper:
            'Reset the 3Panel port forwarding runtime rules in {0}: delete all related rules and chains while retaining database data',
        cleanupDockerBackendHelper:
            'Reset the 3Panel Docker port protection runtime rules in {0}: delete all related rules and chains while retaining database data',
        cleanupBeforeBackendSwitch:
            'The current {0} backend still contains 3Panel runtime rules. Reset it before switching to {1}. Resetting only removes runtime rules; saved database policies are retained and can be initialized or synchronized after switching.',
        cleanupAction: 'Reset',
        backendSwitchNotice:
    ...
    tool: {
        supervisor: {
            ...
            initWarn:
                'This will modify "files" value in "[include"] section in the main configuration file. The directory of other configuration file will be: "{3Panel installation directory}/3panel/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'Allows a small time difference between the identity provider and 3Panel. Keep the default 60 seconds.',
                    ...
                    standardDiscoveryDesc:
                        '3Panel discovers endpoints and capabilities and does not store the raw document.',
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Reads this Attribute from the verified SAML Assertion and maps it to the 3Panel username.',
                    ...
                    syncLogoutHelper:
                        'Signing out of either 3Panel or the identity provider also signs out the other side.',
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Set the user search base and filter, then map the LDAP attribute used as the 3Panel name.',
                    ...
                    attributeMapTooltip: 'JSON mapping from the 3Panel name field to an LDAP attribute.',
                    attributeMapHelper: 'Set the LDAP attribute mapped to the 3Panel name field.',
                    advanced: 'Advanced settings',
                    ...
                    sync: {
                        ...
                        description:
                            'Read the full LDAP directory on a schedule and maintain imported LDAP users in 3Panel.',
                    ...
                    testLoginDesc:
                        'Bind with an AD/LDAP user credential to test authentication only. No 3Panel session is created.',
        ...
        helper: {
            ...
            settingContent1: 'Set a custom welcome message on the 3Panel login page.',
            ...
            appContent1: 'Easily manage your 3Panel server anytime, anywhere.',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper:
                'Only `3panel-agent_v*_*` or `3panel-v*-linux-*` installation packages are supported',
            ...
            panelExist:
                'Detected that this node is running 3Panel V1 service. Please upgrade to V2 using the migration script before adding.',
            coreExist:
            ...
            agentExist:
                'Detected that 3panel-agent is already installed on this node. Continuing will retain existing data and only replace the 3panel-agent service.',
            agentNotExist:
            ...
            fixStatus: 'Run "systemctl status 3panel-agent.service" to check if the service is running.',
            ...
            uninstallHelper: 'This will delete all 3Panel related data of the node. Proceed with caution!',
        ...
        customApp: {
            ...
            imagePrefixHelper:
                'Function: Customize the image prefix and modify the image field in the compose file. For example, when the image prefix is set to 3panel/custom, the image field for MaxKB will change to 3panel/custom/maxkb:v1.10.0',
