...
const message = {
    commons: {
        ...
        login: {
            ...
            licenseHelper: '<Acuerdo de Licencia GPLv3>',
            errorAgree: 'Haga clic para aceptar la Licencia de Software Comunitaria',
            logout: 'Cerrar sesión',
            agreeTitle: 'Acuerdo',
            agreeContent:
                'Para proteger mejor sus derechos e intereses legítimos, por favor lea y acepte el siguiente acuerdo &laquo; <a href = "https://www.gnu.org/licenses/gpl-3.0.html" target = "_blank" > Acuerdo de Licencia GPLv3 </a> &raquo;',
    ...
    home: {
        ...
        restart_3panel: 'Reiniciar panel',
    ...
    database: {
        ...
        supplementPasswordHelper: 'Solo guarda la contraseña existente en 3Panel; no cambia la contraseña en MySQL.',
        pgBindHelper:
        ...
        loadFromRemoteHelper:
            'Esto sincronizará las bases de datos, los usuarios y las autorizaciones del servidor con 3Panel. ¿Desea continuar?',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: 'Este modelo no fue descargado vía 3Panel, no hay registros de descarga relacionados.',
        ...
        benchmark: {
            ...
            tokenizerPlaceholder:
                'Seleccione o introduzca un directorio local de tokenizador, p. ej. /opt/3panel/tokenizers/DeepSeek-V3',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Los argumentos se añaden al comando supergateway. No se pueden cambiar los argumentos de transporte, puerto, ruta y protocolo gestionados por 3Panel',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Se detectó que el contenedor proviene de la Tienda de Aplicaciones. Eliminar el contenedor no lo eliminará completamente de 3Panel. Para eliminarlo por completo, vaya a la Tienda de Aplicaciones -> menús 'Instalado' o 'Entorno de Ejecución'. ¿Continuar?",
        start: 'Iniciar',
        stop: 'Detener',
        restart: 'Reiniciar',
        kill: 'Finalizar',
        ...
        composeHelper:
            'La composición creada mediante el editor o plantilla de 3Panel se guardará en el directorio {0}/docker/compose.',
        ...
        composeDetailHelper:
            'La composición fue creada externamente a 3Panel. Las operaciones de inicio y detención no son compatibles.',
        ...
        composeEnvHelper2:
            'Esta orquestación fue creada por la Tienda de Aplicaciones 3Panel. Modifique las variables de entorno en las aplicaciones instaladas.',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: 'Los archivos de log rotados se respaldarán en el directorio de respaldos de 3Panel.',
        ...
        logHelper1: '1. Registro del sistema de 3Panel',
    ...
    file: {
        ...
        clashDidNotSupport: 'Los nombres de archivo no pueden contener .3panel_clash',
        ...
        panelInstallDir: 'El directorio de instalación de 3Panel no puede eliminarse',
    ...
    setting: {
        ...
        timeZoneHelper:
            'La modificación de zona horaria depende del servicio system timedatectl. Tomará efecto después de reiniciar el servicio 3Panel.',
        timeZoneCN: 'Pekín',
        timeZoneAM: 'Los Ángeles',
        timeZoneNY: 'Nueva York',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: 'Vinculación de dominio de 3Panel configurada',
        ...
        bindDomainHelper: 'Tras vincular el dominio, solo ese dominio podrá acceder al servicio de 3Panel.',
        bindDomainHelper1: 'Déjalo en blanco para desactivar la vinculación de dominio.',
        bindDomainWarning:
            'Tras la vinculación del dominio, se cerrará la sesión y solo se podrá acceder al servicio 3Panel mediante el dominio especificado. ¿Deseas continuar?',
        ...
        mfaTitleHelper:
            'El título se usa para distinguir diferentes hosts de 3Panel. Tras modificarlo, vuelve a escanear o añade la clave secreta manualmente.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'Esta regla se usará para comprimir y respaldar el directorio de datos de 3Panel al crear la instantánea. Por defecto, se ignoran los archivos de socket.',
        ignoreHelper1: 'Una por línea. Por ejemplo,\n*.log\n/opt/3panel/cache',
        panelInfo: 'Escribir información básica de 3Panel',
        panelBin: 'Respaldar archivos del sistema 3Panel',
        daemonJson: 'Respaldar archivo de configuración de Docker',
        appData: 'Respaldar aplicaciones instaladas de 3Panel',
        panelData: 'Respaldar directorio de datos de 3Panel',
        backupData: 'Respaldar directorio local de respaldo de 3Panel',
        ...
        recoverHelper1: 'La recuperación requiere reiniciar Docker y los servicios de 3Panel',
        recoverHelper2:
        ...
        rollback: 'Reversión',
        rollbackHelper:
            'Revertir esta recuperación reemplazará todos los archivos de esta recuperación y puede requerir reiniciar Docker y los servicios de 3Panel. ¿Deseas continuar?',
        upgradeRecord: 'Registro de actualización',
        upgrading: ' Actualizando, por favor espera...',
        upgradeHelper: 'La actualización requiere reiniciar el servicio 3Panel. ¿Deseas continuar?',
        ...
        rollbackLocalHelper:
            'El nodo principal no admite reversión directa. ¡Ejecuta manualmente el comando [3pctl restore] para revertir!',
    ...
    clean: {
        ...
        scanHelper: 'Limpie fácilmente archivos basura generados por 3Panel',
        clean: 'Limpiar ahora',
    ...
    ssl: {
        ...
        shellHelper:
            'Por defecto, el script se ejecuta en el directorio de instalación de 3Panel. Si se guarda el certificado, será en ese directorio. Timeout: 30 minutos.',
    ...
    firewall: {
        ...
        managedHelper: 'Creada y mantenida por 3Panel. Se puede editar o eliminar.',
        adopted: 'Externa gestionada',
        adoptedHelper: 'Una regla existente del sistema que ahora mantiene 3Panel.',
        external: 'Regla externa',
        externalHelper:
            'Regla existente del sistema que aún no gestiona 3Panel. Se puede adoptar cuando sea necesario.',
        ...
        adoptRuleConfirm: 'Después de asumirla, 3Panel podrá mantener y eliminar esta regla existente. ¿Continuar?',
        ...
        scopeUnmanagedActive: 'Se detectaron otros ámbitos activos: {0}. 3Panel no modificará sus reglas.',
        ...
        dockerFirewallHelper: 'Selecciona cómo gestiona 3Panel la protección de puertos de contenedores.',
        ...
        ruleSyncDatabase: 'Base de datos de 3Panel',
        ruleSyncDatabaseHelper:
            'Sincroniza y concilia las reglas administradas del firewall actual con las reglas de la base de datos de 3Panel. Se añadirán las reglas que falten y se eliminarán las sobrantes.',
        ...
        resetDirectRulesHelper:
            'Elimina de {0} las cadenas, reglas activas y archivos persistentes del firewall de 3Panel; se conservan las políticas de la base de datos',
        ...
        cleanupForwardingBackendHelper:
            'Restablece las reglas de ejecución del reenvío de puertos de 3Panel en {0}: elimina todas las reglas y cadenas relacionadas y conserva los datos de la base de datos',
        cleanupDockerBackendHelper:
            'Restablece las reglas de ejecución de protección de puertos Docker de 3Panel en {0}: elimina todas las reglas y cadenas relacionadas y conserva los datos de la base de datos',
        cleanupBeforeBackendSwitch:
            'El backend actual {0} todavía contiene reglas de ejecución de 3Panel. Restablézcalo antes de cambiar a {1}. El restablecimiento solo elimina las reglas de ejecución; las políticas de la base de datos se conservan y pueden inicializarse o sincronizarse después del cambio.',
    ...
    tool: {
        supervisor: {
            ...
            initWarn:
                'Esto modificará el valor de "files" en la sección "[include]" del archivo de configuración principal. El directorio de otros archivos de configuración será: "{directorio de instalación de 3Panel}/3panel/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'Permite una pequeña diferencia horaria entre el proveedor de identidad y 3Panel. Mantenga el valor predeterminado de 60 segundos.',
                    ...
                    standardDiscoveryDesc:
                        '3Panel descubre los endpoints y las capacidades, pero no almacena el documento sin procesar.',
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Lee este atributo de la aserción SAML verificada y lo asigna al nombre de usuario de 3Panel.',
                    ...
                    syncLogoutHelper:
                        'Cerrar sesión en 3Panel o en el proveedor de identidad también cierra la sesión del otro lado.',
                    testBeforeBrowserTest:
                        'Pruebe la configuración actual antes de iniciar la prueba de inicio de sesión en el navegador.',
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Configure la base y el filtro de búsqueda, y asigne el atributo LDAP al campo name de 3Panel.',
                    ...
                    attributeMapTooltip: 'Mapeo JSON del campo name de 3Panel a un atributo LDAP.',
                    attributeMapHelper: 'Configure el atributo LDAP asignado al campo name de 3Panel.',
                    ...
                    sync: {
                        ...
                        description:
                            'Lea el directorio LDAP completo de forma programada y mantenga los usuarios LDAP importados en 3Panel.',
                    ...
                    testLoginDesc:
                        'Vincule con una credencial de usuario AD/LDAP para probar solo la autenticación. No se crea ninguna sesión 3Panel.',
        ...
        helper: {
            ...
            settingContent1: 'Configura un mensaje de bienvenida en la página de login de 3Panel.',
            ...
            appContent1: 'Gestiona tu servidor 3Panel en cualquier momento y lugar.',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper:
                'Solo se admiten paquetes de instalación `3panel-agent_v*_*` o `3panel-v*-linux-*`',
            ...
            panelExist:
                'Se ha detectado que este nodo ejecuta 3Panel V1. Actualiza a V2 usando el script de migración antes de añadirlo.',
            coreExist:
            ...
            agentExist:
                'Se ha detectado que 3panel-agent ya está instalado en este nodo. Continuar conservará los datos y solo reemplazará el servicio de 3panel-agent.',
            agentNotExist:
            ...
            fixStatus:
                'Ejecuta "systemctl status 3panel-agent.service" para verificar si el servicio está en ejecución.',
            ...
            uninstallHelper:
                'Esto eliminará todos los datos relacionados con 3Panel de este nodo. Procede con precaución.',
        ...
        customApp: {
            ...
            imagePrefixHelper:
                'Función: Personaliza el prefijo de la imagen y modifica el campo image en el archivo compose. Ejemplo: si el prefijo es 3panel/custom, la imagen de MaxKB pasará a ser 3panel/custom/maxkb:v1.10.0',
