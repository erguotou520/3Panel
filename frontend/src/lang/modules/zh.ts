...
const message = {
    commons: {
        ...
        login: {
            ...
            licenseHelper: '《GPLv3 开源许可协议》',
            errorAgree: '请点击同意社区软件许可协议',
            agreeTitle: '服务协议及隐私保护',
            agreeContent:
                '为了更好的保障您的合法权益，请您阅读并同意以下协议 &laquo; <a href="https://www.gnu.org/licenses/gpl-3.0.html" target="_blank"> GPLv3 开源许可协议 </a> &raquo;',
            logout: '退出登录',
        },
        rule: {
            username: '请输入用户名',
    ...
    database: {
        ...
        supplementPasswordHelper: '仅将现有密码保存到 3Panel，不会修改 MySQL 用户密码。',
        noUserBind: '不绑定',
        pgBindHelper: '该操作用于创建新用户并将其绑定到目标数据库，暂不支持选择已存在于数据库中的用户。',
        pgSuperUser: '超级用户',
        loadFromRemoteHelper: '此操作将同步服务器上的数据库、用户及授权信息到 3Panel，是否继续？',
    ...
    aiTools: {
        agents: {
            ...
            modelMetadata: '模型能力配置',
            modelMetadataHelper: '配置仅作用于当前 OpenClaw。留空时使用 OpenClaw 或模型供应商的默认值。',
            inputModeAuto: '自动识别',
            inputModeText: '仅文本',
            inputModeImage: '文本和图片',
            contextWindow: '上下文窗口',
            useModelDefault: '使用模型默认值',
            reasoning: '推理模型',
            verified: '验证状态',
            verifySkipped: '不验证',
            skillsTab: '技能',
        ...
        model: {
            ...
            from_remote: '该模型并非通过 3Panel 下载，无相关拉取日志。',
        ...
        benchmark: {
            ...
            endpoint: '接口路径',
            tokenizer: '分词器',
            tokenizerPlaceholder: '请选择或输入本地分词器目录，例如 /opt/3panel/tokenizers/DeepSeek-V3',
            runConfig: '运行配置',
            rawResult: '原始结果',
            resultMetrics: '结果指标',
            contextTokens: '上下文长度',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                '参数将追加到 supergateway 启动命令，不支持修改由 3Panel 管理的传输、端口、路径和协议参数',
            testConnection: '测试连接',
    ...
    container: {
        ...
        containerDeleteHelper:
            '检测到容器来源于应用商店，删除容器不会将其从 3Panel 中完全移除。如需彻底删除，请前往应用商店-『已安装』或『运行环境』等菜单中操作。是否继续？',
        start: '启动',
        stop: '停止',
        restart: '重启',
        kill: '强制停止',
        ...
        network: '网络',
        networkHelper: '删除 3panel-network 容器网络将影响部分应用和运行环境的正常使用，是否继续？',
        networkName: '网络名',
        driver: '模式',
        option: '参数',
        attachable: '可用',
        ...
        composeHelper: '通过 3Panel 编辑或模版创建的编排，将保存在 {0}/docker/compose 路径下',
        deleteFile: '删除文件',
        ...
        exited: '已停止',
        running: '运行中 ( {0} / {1} )',
        composeDetailHelper: '该 compose 为 3Panel 编排外部创建。暂不支持启停操作。',
        composeOperatorHelper: '将对 {0} 进行 {1} 操作，是否继续？',
        composeDownHelper: '将停止并删除 {0} 编排下所有容器及网络，是否继续？',
        composeEnvHelper2: '该编排为 3Panel 应用商店创建，请在已安装应用中修改环境变量。',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: '切割的日志文件会备份到 3Panel 的 backup 目录下',
    ...
    file: {
        ...
        clashDidNotSupport: '文件名禁止包含 .3panel_clash',
        ...
        previewLargeFile: '预览',
        panelInstallDir: '3Panel 安装目录不能删除',
        wgetTask: '下载任务',
    ...
    setting: {
        ...
        timeZoneHelper: '时区修改依赖系统 timedatectl 服务，重启 3Panel 服务后生效。',
        timeZoneCN: '北京',
        timeZoneAM: '洛杉矶',
        timeZoneNY: '纽约',
        ntpALi: '阿里云',
        ...
        developerModeHelper: '获取 3Panel 的预览版本，以分享有关新功能和更新的反馈',
        ...
        ignoreHelper: '快照时将使用该规则对 3Panel 数据目录进行压缩备份，请谨慎修改。',
        ignoreHelper1: '一行一个，例： \n*.log\n/opt/3panel/cache',
        status: '快照状态',
        panelInfo: '写入 3Panel 基础信息',
        panelBin: '备份 3Panel 系统文件',
        daemonJson: '备份 Docker 配置文件',
        appData: '备份 3Panel 已安装应用',
        panelData: '备份 3Panel 数据目录',
        backupData: '备份 3Panel 本地备份目录',
        compress: '制作快照文件',
        upload: '上传快照文件',
        recoverDetail: '恢复详情',
        ...
        recoverHelper1: '恢复需要重启 Docker 以及 3Panel 服务',
        ...
        rollback: '回滚',
        rollbackHelper:
            '即将回滚本次恢复，回滚将替换所有本次恢复的文件，过程中可能需要重启 Docker 以及 3Panel 服务，是否继续？',

        upgradeRecord: '更新记录',
        upgrading: '正在升级中，请稍候...',
        upgradeHelper: '升级操作需要重启 3Panel 服务，是否继续？',
        noUpgrade: '当前已经是最新版本',
        versionHelper: '3Panel 版本号命名规则为： [大版本].[功能版本].[Bug 修复版本]，例：',
        rollbackLocalHelper: '主节点暂不支持直接回滚，请手动执行 3pctl restore 命令回滚！',
        upgradeCheck: '检查更新',
        upgradeNotes: '更新内容',
        upgradeNow: '立即更新',
        source: '下载源',
        ...
        bindDomainHelper: '设置域名绑定后，仅能通过设置中域名访问 3Panel 服务',
        bindDomainHelper1: '绑定域名为空时，则取消域名绑定',
        bindDomainWarning: '设置域名绑定后，将退出当前登录，且仅能通过设置中域名访问 3Panel 服务，是否继续？',
        allowIPs: '授权 IP',
        unAllowIPs: '取消授权',
        unAllowIPsWarning: '授权 IP 为空将允许所有 IP 访问系统，可能造成系统不安全，是否继续？',
        allowIPsHelper: '设置授权 IP 后，仅有设置中的 IP 可以访问 3Panel 服务',
        allowIPsWarning: '设置授权 IP 后，仅有设置中的 IP 可以访问 3Panel 服务，是否继续？',
        ...
        mfaCode: '验证码',
        mfaInterval: '刷新时间（秒）',
        mfaTitleHelper: '用于区分不同 3Panel 主机，修改后请重新扫描或手动添加密钥信息！',
        mfaIntervalHelper:
        ...
        passkeyPrereqBindDomain: '已设置 3Panel 域名绑定',
    ...
    license: {
        ...
        securityWarningContent:
            '3Panel 需要以具备系统管理权限的用户运行，非官方许可证或被篡改版本可能导致服务器失控、数据泄露等严重安全风险。请通过官方渠道获取许可证和安装包。',
        ...
        vm: '升级商业版，即可在 3Panel 中统一管理虚拟机、镜像与模板、虚拟网络和存储资源。',
        node: '升级商业版可以使用 3Panel 管理多台 linux 服务器。',
        ...
        vllm: '升级商业版可将 vLLM 服务统一纳入 3Panel 管理，集中完成部署、配置调整、状态运维与任务追踪，降低本地模型服务维护成本。',
        'model-downloader':
            '升级商业版可从 HuggingFace、ModelScope 或兼容镜像站搜索、下载并管理本地模型文件，统一维护本地模型目录与下载任务。',
    },
    clean: {
        scan: '开始扫描',
        scanHelper: '轻松梳理 3Panel 运行期间积累的垃圾文件',
        clean: '立即清理',
        reScan: '重新扫描',
    ...
    ssl: {
        ...
        shell: '脚本内容',
        shellHelper:
            '脚本默认执行目录为 3Panel 安装目录，如果有推送证书，那么执行目录为证书推送目录。默认超时时间 30 分钟',
    ...
    firewall: {
        ...
        unUsed: '未使用',
        managed: '面板创建',
        managedHelper: '由 3Panel 创建并管理。',
        adopted: '外部纳管',
        adoptedHelper: '系统原有规则，现由 3Panel 管理。',
        external: '外部规则',
        externalHelper: '尚未纳入 3Panel 管理。',
        protected: '系统保护',
        ...
        adoptRuleConfirm: '纳入管理后，3Panel 将负责维护和删除这条现有规则，是否继续？',
        plan_exact_rule_conflict: '已存在匹配条件相同、但允许与拒绝动作相反的规则。',
        allRulesAlreadyExist: '本次检查的 {0} 条规则均已存在，没有需要创建的新规则。',
        plan_managed_rule_drifted:
            '这条规则在 3Panel 中的记录与防火墙实际状态不一致，请先刷新规则；如仍异常，请重新同步。',
        plan_opaque_rule_in_target_scope:
            '当前防火墙中存在 3Panel 暂不支持的规则。为避免影响现有访问，本次未创建。请返回规则列表，查看内容无法完整显示的“外部规则”，并在系统防火墙中处理后重试。',
        ...
        scopeUnmanagedActive: '检测到其他活动范围：{0}，3Panel 不会修改其中的规则。',
        ...
        dockerFirewallHelper: '用于选择 3Panel 容器端口防护的管理方式。',
        ...
        ruleSyncTitle: '同步规则',
        ruleSyncAction: '同步规则',
        ruleSyncDatabase: '3Panel 数据库',
        ruleSyncDatabaseHelper:
            '以 3Panel 数据库规则为准，同步并校准当前防火墙中的管理规则。缺失规则会被添加，多余规则会被删除。',
        ...
        ruleSyncReasonDetail: {
            matchesDatabasePolicy: '该规则已与 3Panel 保存的设置一致。',
            managedOrderDiffers: '防火墙中的规则顺序与 3Panel 保存的顺序不一致，本次将调整。',
            managedOnlyInTarget: '该规则仍存在于防火墙中，但 3Panel 已不再保存，本次将删除。',
            managedRuntimeCannotRemove: '该规则仅在当前运行中生效，3Panel 无法确认删除后的影响，因此本次不会删除。',
            missingFromTarget: '防火墙中缺少该规则，本次将补充。',
            targetDiffers: '防火墙中的规则与 3Panel 保存的设置不一致，本次将修复。',
        ...
        resetDirectRulesHelper: '删除 {0} 中全部 3Panel 系统防火墙链、运行规则及持久化文件，保留数据库策略',
        resetWhitelistRulesHelper:
            '重置 {0} 中当前生效的自定义防火墙配置，恢复安装默认状态并停用 {0}；数据库策略会保留，之后可以重新同步。',
        cleanupForwardingBackendHelper:
            '重置 {0} 中的 3Panel 端口转发运行时规则：删除全部相关规则及规则链，仅保留数据库数据',
        cleanupDockerBackendHelper:
            '重置 {0} 中的 3Panel Docker 端口防护运行时规则：删除全部相关规则及规则链，仅保留数据库数据',
        cleanupBeforeBackendSwitch:
            '当前后端 {0} 仍存在 3Panel 运行时规则，请先重置该后端，再切换到 {1}。重置仅清理运行时规则，数据库策略会保留，切换后可以重新初始化或同步。',
        cleanupAction: '重置',
        backendSwitchNotice:
    ...
    tool: {
        supervisor: {
            ...
            numprocs: '进程数量',
            initWarn:
                '初始化操作需要修改配置文件的 [include] files 参数，修改后的服务配置文件所在目录: 3panel安装目录/3panel/tools/supervisord/supervisor.d/',
            operatorHelper: '将对 {0} 进行 {1} 操作，是否继续？',
            uptime: '运行时长',
    ...
    xpack: {
        ...
        helper: {
            ...
            settingContent1: '在 3Panel 登录页上设置自定义的欢迎语。',
            ...
            vmTitle1: '虚拟机管理',
            vmContent1: '创建和管理虚拟机，查看运行状态并调整资源配置。',
            vmTitle2: '镜像与模板',
            vmContent2: '统一管理 ISO 镜像和虚拟机模板，便捷创建虚拟机。',
            vmTitle3: '虚拟网络',
            vmContent3: '集中管理虚拟网络，配置虚拟机网络连接。',
            vmTitle4: '存储池',
            vmContent4: '统一管理存储池，为虚拟机分配存储资源。',
            nodeTitle1: '一键添加节点',
            ...
            appTitle1: '灵活管理面板',
            appContent1: '随时随地轻松管理你的 3Panel 服务器。',
            appTitle2: '全面服务信息',
            ...
            vllmTitle1: '统一纳管',
            vllmContent1: '将分散的 vLLM 服务统一接入 3Panel，集中查看实例、版本、状态与运行目录。',
            vllmTitle2: '快速部署',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper: '仅支持 `3panel-agent_v*_*` 或 `3panel-v*-linux-*` 安装包',
            ...
            checkPort: '检查节点端口可达',
            panelExist: '检查到该节点正在运行 3Panel V1 服务，请先通过迁移脚本升级至 V2 后再进行添加。',
            coreExist:
                '当前节点已作为主节点启用，无法直接作为从节点添加。请先将其降级为从节点后再添加，具体可参考文档。',
            agentExist: '检查到该节点已安装 3panel-agent，继续添加将保留现有数据，仅替换 3panel-agent 服务。',
            agentNotExist: '检查到该节点未安装 3panel-agent，无法直接编辑该节点信息，请先删除后重新添加。',
            oldDataExist: '检查到该节点存在 3Panel V2 历史数据，将使用以下信息覆盖当前设置',
            ...
            fixStatus: 'systemctl status 3panel-agent.service 检查服务是否已启动',
            ...
            uninstall: '删除节点数据',
            uninstallHelper: '将删除节点所有 3Panel 相关数据，谨慎选择！',
        ...
        customApp: {
            ...
            imagePrefix: '镜像前缀',
            imagePrefixHelper:
                '用于自定义镜像前缀，自动修改 Compose 文件中的镜像字段。\n 例如，当镜像前缀设置为 3panel/custom 时，MaxKB 的镜像将变更为 3panel/custom/maxkb:v1.10.0。',
