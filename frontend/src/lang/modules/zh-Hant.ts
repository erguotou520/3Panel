...
const message = {
    commons: {
        ...
        login: {
            ...
            mfaCode: 'MFA 驗證碼',
            title: 'Linux 伺服器維運面板',
            licenseHelper: '《GPLv3 開源許可協議》',
            errorAgree: '請點選同意社區軟體許可協議',
            agreeTitle: '服務協議及隱私保護',
            agreeContent:
                '為了更好的保障您的合法權益，請您閱讀並同意以下協議 &laquo; <a href="https://www.gnu.org/licenses/gpl-3.0.html" target="_blank"> GPLv3 開源許可協議 </a> &raquo;',
            logout: '登出',
    ...
    database: {
        ...
        supplementPasswordHelper: '僅將現有密碼儲存到 3Panel，不會修改 MySQL 使用者密碼。',
        noUserBind: '未綁定',
        pgBindHelper: '此操作用於建立新使用者並將其綁定到目標資料庫，暫不支援選擇已存在於資料庫中的使用者。',
        pgSuperUser: '超級使用者',
        loadFromRemoteHelper: '此操作將同步伺服器上的資料庫、使用者及授權資訊到 3Panel，是否繼續？',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: '該模型並非透過 3Panel 下載，無相關拉取日誌。',
        ...
        benchmark: {
            ...
            endpoint: '介面路徑',
            tokenizer: '分詞器',
            tokenizerPlaceholder: '請選擇或輸入本機分詞器目錄，例如 /opt/3panel/tokenizers/DeepSeek-V3',
            runConfig: '執行設定',
            rawResult: '原始結果',
            resultMetrics: '結果指標',
            contextTokens: '上下文長度',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                '參數將附加到 supergateway 啟動命令，不支援修改由 3Panel 管理的傳輸、連接埠、路徑和協議參數',
            testConnection: '測試連線',
    ...
    container: {
        ...
        containerDeleteHelper:
            '偵測到容器來源於應用商店，刪除容器不會將其從 3Panel 中完全移除。如需徹底刪除，請前往應用商店-『已安裝』或『運行環境』等選單中操作。是否繼續？',
        start: '啟動',
        stop: '停止',
        restart: '重新啟動',
        kill: '強制停止',
        ...
        network: '網路',
        networkHelper: '刪除 3panel-network 容器網路將影響部分應用和執行環境的正常使用，是否繼續？',
        networkName: '網路名',
        driver: '模式',
        option: '參數',
        attachable: '可用',
        ...
        composeHelper: '通過 3Panel 編輯或範本建立的編排，將儲存在 {0}/docker/compose 路徑下',
        deleteFile: '刪除檔案',
        ...
        exited: '已停止',
        running: '執行中 ( {0} / {1} )',
        composeDetailHelper: '該 compose 為 3Panel 編排外部建立。暫不支援啟停操作。',
        composeOperatorHelper: '將對 {0} 進行 {1} 操作，是否繼續？',
        composeDownHelper: '將停止並刪除 {0} 編排下所有容器及網路，是否繼續？',
        composeEnvHelper2: '該編排為 3Panel 應用商店建立，請在已安裝應用中修改環境變數。',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: '切割的日誌檔案會備份到 3Panel 的 backup 目錄下',
    ...
    file: {
        ...
        clashDidNotSupport: '檔名禁止包含 .3panel_clash',
        ...
        previewLargeFile: '預覽',
        panelInstallDir: '3Panel 安裝目錄不能刪除',
        wgetTask: '下載任務',
    ...
    setting: {
        ...
        timeZoneHelper: '時區修改依賴系統 timedatectl 服務，重新啟動 3Panel 服務後生效。',
        timeZoneCN: '北京',
        timeZoneAM: '洛杉磯',
        timeZoneNY: '紐約',
        ntpALi: '阿里雲',
        ...
        developerModeHelper: '取得 3Panel 的預覽版本，以分享有關新功能和更新的回饋',
        thirdParty: '第三方帳號',
        scope: '使用範圍',
        public: '公有',
        ...
        ignoreHelper: '快照時將使用該規則對 3Panel 資料目錄進行壓縮備份，請謹慎修改。',
        ignoreHelper1: '一行一個，例： \n*.log\n/opt/3panel/cache',
        status: '快照狀態',
        panelInfo: '寫入 3Panel 基礎資訊',
        panelBin: '備份 3Panel 系統檔案',
        daemonJson: '備份 Docker 設定檔',
        appData: '備份 3Panel 已安裝應用',
        panelData: '備份 3Panel 資料目錄',
        backupData: '備份 3Panel 本機備份目錄',
        compress: '製作快照檔案',
        upload: '上傳快照檔案',
        recoverDetail: '復原詳情',
        ...
        recoverHelper1: '復原需要重新啟動 Docker 以及 3Panel 服務',
        ...
        rollback: '回滾',
        rollbackHelper:
            '即將回滾本次復原，回滾將取代所有本次復原的檔案，過程中可能需要重新啟動 Docker 以及 3Panel 服務，是否繼續？',
        upgradeRecord: '升級記錄',
        upgrading: '正在升級中，請稍候',
        upgradeHelper: '升級操作需要重新啟動 3Panel 服務，是否繼續？',
        noUpgrade: '已是最新版本',
        versionHelper: '3Panel 版本號命名規則為： [大版本].[功能版本].[Bug 修復版本]，例：',
        rollbackLocalHelper: '主節點暫不支援直接回滾，請手動執行「3pctl restore」指令回滾',
        upgradeCheck: '檢查更新',
        upgradeNotes: '更新內容',
        upgradeNow: '立即更新',
        source: '下載源',
        ...
        passkeyPrereqBindDomain: '已設定 3Panel 網域綁定',
        ...
        bindDomainHelper: '設定網域綁定後，僅能透過設定中域名存取 3Panel 服務',
        bindDomainHelper1: '綁定域名為空時，則取消網域綁定',
        bindDomainWarning: '設定網域綁定後，將退出目前登入，且僅能透過設定中域名存取 3Panel 服務，是否繼續？',
        allowIPs: '授權 IP',
        unAllowIPs: '取消授權',
        unAllowIPsWarning: '授權 IP 為空將允許所有 IP 存取系統，可能造成系統不安全，是否繼續？',
        allowIPsHelper: '設定授權 IP 後，僅有設定中的 IP 可以存取 3Panel 服務',
        allowIPsWarning: '設定授權 IP 後，僅有設定中的 IP 可以存取 3Panel 服務，是否繼續？',
        ...
        mfaTitleHelper: '用於區分不同 3Panel 主機，修改後請重新掃描或手動新增金鑰資訊',
        mfaIntervalHelper:
    ...
    license: {
        ...
        securityWarningContent:
            '3Panel 需要以具備系統管理權限的使用者執行，非官方許可證或被竄改版本可能導致伺服器失控、資料外洩等嚴重安全風險。請透過官方管道取得許可證和安裝包。',
        ...
        vm: '升級商業版，即可在 3Panel 中統一管理虛擬機、映像與範本、虛擬網路和儲存資源。',
        node: '升級商業版可以使用 3Panel 管理多台 Linux 伺服器。',
        ...
        vllm: '升級商業版可將 vLLM 服務統一納入 3Panel 管理，集中完成部署、設定調整、狀態維運與任務追蹤，降低本地模型服務維護成本。',
        'model-downloader':
            '升級商業版可從 HuggingFace、ModelScope 或相容鏡像站搜尋、下載並管理本機模型檔案，統一維護本機模型目錄與下載任務。',
    },
    clean: {
        scan: '開始掃描',
        scanHelper: '輕鬆梳理 3Panel 執行期間積累的垃圾檔案',
        clean: '立即清理',
        reScan: '重新掃描',
    ...
    website: {
        ...
        websiteDeploymentHelper: '使用從 3Panel 部署的應用建立網站',
        ...
        wafValueHelper: '值',
        runtimeProxyHelper: '使用從 3Panel 建立的執行環境',
        runtime: '執行環境',
    ...
    ssl: {
        ...
        shell: '腳本內容',
        shellHelper:
            '腳本預設執行目錄為 3Panel 安裝目錄，如果有推送憑證，那麼執行目錄為憑證推送目錄。預設逾時時間 30 分鐘',
    ...
    firewall: {
        ...
        unUsed: '未使用',
        managed: '面板建立',
        managedHelper: '由 3Panel 建立並管理。',
        adopted: '外部納管',
        adoptedHelper: '系統原有規則，現由 3Panel 管理。',
        external: '外部規則',
        externalHelper: '尚未納入 3Panel 管理。',
        protected: '系統保護',
        ...
        adoptRuleConfirm: '納入管理後，3Panel 將負責維護及刪除這條現有規則，是否繼續？',
        plan_exact_rule_conflict: '已存在比對條件相同、但允許與拒絕動作相反的規則。',
        allRulesAlreadyExist: '本次檢查的 {0} 條規則均已存在，沒有需要建立的新規則。',
        plan_managed_rule_drifted: '3Panel 管理記錄與系統實際規則不一致，請檢查系統規則。',
        ...
        scopeUnmanagedActive: '偵測到其他使用中範圍：{0}，3Panel 不會修改其中的規則。',
        ...
        dockerFirewallHelper: '用於選擇 3Panel 容器連接埠防護的管理方式。',
        ...
        ruleSyncTitle: '同步規則',
        ruleSyncAction: '同步規則',
        ruleSyncDatabase: '3Panel 資料庫',
        ruleSyncDatabaseHelper:
            '以 3Panel 資料庫規則為準，同步並校準目前防火牆中的管理規則。缺少的規則會被新增，多餘的規則會被刪除。',
        ...
        resetDirectRulesHelper: '刪除 {0} 中全部 3Panel 系統防火牆鏈、執行規則及持久化檔案，保留資料庫策略',
        resetWhitelistRulesHelper:
            '重設 {0} 中目前生效的自訂防火牆設定，恢復安裝預設狀態並停用 {0}；資料庫策略會保留，之後可重新同步。',
        cleanupForwardingBackendHelper:
            '重設 {0} 中的 3Panel 連接埠轉送執行時規則：刪除全部相關規則及規則鏈，僅保留資料庫資料',
        cleanupDockerBackendHelper:
            '重設 {0} 中的 3Panel Docker 連接埠防護執行時規則：刪除全部相關規則及規則鏈，僅保留資料庫資料',
        cleanupBeforeBackendSwitch:
            '目前後端 {0} 仍存在 3Panel 執行時規則，請先重設該後端，再切換到 {1}。重設僅清理執行時規則，資料庫策略會保留，切換後可重新初始化或同步。',
        cleanupAction: '重設',
        backendSwitchNotice:
    ...
    tool: {
        supervisor: {
            ...
            numprocs: '行程數量',
            initWarn:
                '初始化操作需要修改設定檔的 [include] files 參數，修改後的服務設定檔所在目錄: 3panel安裝目錄/3panel/tools/supervisord/supervisor.d/',
            operatorHelper: '將對 {0} 進行 {1} 操作，是否繼續？ ',
            uptime: '執行時長',
    ...
    xpack: {
        ...
        helper: {
            ...
            settingTitle1: '自訂歡迎語',
            settingContent1: '在 3Panel 登入頁上設定自訂的歡迎語。',
            ...
            appTitle1: '靈活管理面板',
            appContent1: '隨時隨地輕鬆管理你的 3Panel 伺服器。',
            appTitle2: '全面服務資訊',
            ...
            vllmTitle1: '統一納管',
            vllmContent1: '將分散的 vLLM 服務統一接入 3Panel，集中檢視實例、版本、狀態與執行目錄。',
            vllmTitle2: '快速部署',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper: '僅支援 `3panel-agent_v*_*` 或 `3panel-v*-linux-*` 安裝包',
            ...
            checkPort: '檢查節點埠可達',
            panelExist: '檢查到該節點正在執行 3Panel V1 服務，請先透過遷移腳本升級至 V2 後再進行新增。',
            coreExist:
                '目前節點已作為主節點啟用，無法直接作為從節點新增。請先將其降級為從節點後再新增，詳細可參考檔案。',
            agentExist: '檢查到該節點已安裝 3panel-agent，繼續新增將保留現有資料，僅取代 3panel-agent 服務。',
            agentNotExist: '偵測到該節點未安裝 3panel-agent，無法直接編輯該節點資訊，請先刪除後重新新增。',
            oldDataExist: '檢查到該節點存在 3Panel V2 歷史資料，將使用以下資訊覆蓋目前設定',
            ...
            fixStatus: '執行 "systemctl status 3panel-agent.service" 以檢查服務是否已啟動。',
            ...
            uninstall: '刪除節點資料',
            uninstallHelper: '此操作將刪除與節點相關的所有 3Panel 資料，請謹慎選擇',
        ...
        customApp: {
            ...
            imagePrefix: '映像前綴',
            imagePrefixHelper:
                '作用：自訂映像前綴，修改 compose 檔案中的映像欄位，例：當映像前綴設定為 3panel/custom 時，MaxKB 的映像欄位將變更為 3panel/custom/maxkb:v1.10.0',
