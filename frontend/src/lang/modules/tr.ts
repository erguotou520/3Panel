...
const message = {
    ...
    home: {
        ...
        restart_3panel: 'Paneli yeniden başlat',
    ...
    database: {
        ...
        supplementPasswordHelper: 'Yalnızca mevcut parolayı 3Panel içine kaydeder; MySQL parolasını değiştirmez.',
        ...
        loadFromRemoteHelper:
            'Sunucudaki veritabanlarını, kullanıcıları ve yetkilendirmeleri 3Panel ile eşitler. Devam edilsin mi?',
    ...
    aiTools: {
        agents: {
            ...
            modelMetadata: 'Model yetenekleri',
            modelMetadataHelper:
                'Bu ayarlar yalnızca mevcut OpenClaw örneğine uygulanır. OpenClaw veya sağlayıcı varsayılanlarını kullanmak için boş bırakın.',
            inputModeAuto: 'Otomatik algıla',
            inputModeText: 'Yalnızca metin',
            inputModeImage: 'Metin ve görseller',
            contextWindow: 'Bağlam penceresi',
            useModelDefault: 'Model varsayılanını kullan',
        ...
        model: {
            ...
            from_remote: 'Bu model 3Panel aracılığıyla indirilmedi, ilgili çekme logları yok.',
        ...
        benchmark: {
            ...
            endpoint: 'Endpoint',
            tokenizer: 'Tokenizer',
            tokenizerPlaceholder: 'Yerel tokenizer dizini seçin veya girin, örn. /opt/3panel/tokenizers/DeepSeek-V3',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Bağımsız değişkenler supergateway komutuna eklenir. 3Panel tarafından yönetilen aktarım, bağlantı noktası, yol ve protokol bağımsız değişkenleri değiştirilemez',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Kapsayıcının Uygulama Mağazası'ndan geldiği tespit edildi. Kapsayıcıyı silmek, onu 3Panel'den tamamen kaldırmaz. Tamamen silmek için lütfen Uygulama Mağazası -> 'Yüklü' veya 'Çalışma Ortamı' menülerine gidin. Devam edilsin mi?",
        start: 'Başlat',
        stop: 'Durdur',
        restart: 'Yeniden başlat',
        kill: 'Öldür',
        ...
        composeHelper:
            '3Panel editörü veya şablonu aracılığıyla oluşturulan kompozisyon {0}/docker/compose dizinine kaydedilecektir.',
        ...
        composeDetailHelper: 'Compose, 3Panel dışında oluşturulmuştur. Başlatma ve durdurma işlemleri desteklenmez.',
        ...
        composeEnvHelper2:
            'Bu düzenleme 3Panel Uygulama Mağazası tarafından oluşturuldu. Lütfen ortam değişkenlerini yüklü uygulamalarda değiştirin.',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: 'Döndürülen log dosyaları 3Panel yedek dizinine yedeklenecektir.',
        ...
        logHelper1: '1. 3Panel sistem günlüğü',
    ...
    file: {
        ...
        clashDidNotSupport: 'Dosya adlarının .3panel_clash içermesi yasaktır',
        ...
        panelInstallDir: '3Panel kurulum dizini silinemez',
    ...
    setting: {
        ...
        timeZoneHelper:
            'Saat dilimi değişikliği, sistem timedatectl servisine bağlıdır. 3Panel servisi yeniden başlatıldıktan sonra etkili olur.',
        timeZoneCN: 'Pekin',
        timeZoneAM: 'Los Angeles',
        timeZoneNY: 'New York',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: '3Panel alan adı bağlama yapılandırıldı',
        ...
        bindDomainHelper: 'Alan adı bağlandıktan sonra, yalnızca o alan adı 3Panel servisine erişebilir.',
        bindDomainHelper1: 'Alan adı bağlamasını devre dışı bırakmak için boş bırakın.',
        bindDomainWarning:
            'Alan adı bağlamasından sonra oturumunuz kapatılacak ve yalnızca ayarlarınızda belirtilen alan adı üzerinden 3Panel servisine erişebilirsiniz. Devam etmek istiyor musunuz?',
        allowIPs: 'Yetkili IP',
        ...
        mfaTitleHelper:
            'Başlık, farklı 3Panel ana bilgisayarlarını ayırt etmek için kullanılır. Başlığı değiştirdikten sonra QR kodunu tekrar tarayın veya gizli anahtarı manuel olarak ekleyin.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'Bu kural, anlık görüntü oluştururken 3Panel veri dizinini sıkıştırmak ve yedeklemek için kullanılacaktır. Varsayılan olarak, soket dosyaları yok sayılır.',
        ignoreHelper1: 'Her satıra bir tane. Örneğin,\n*.log\n/opt/3panel/cache',
        panelInfo: '3Panel temel bilgilerini yaz',
        panelBin: '3Panel sistem dosyalarını yedekle',
        daemonJson: 'Docker yapılandırma dosyasını yedekle',
        appData: '3Panel’den yüklenen uygulamaları yedekle',
        panelData: '3Panel veri dizinini yedekle',
        backupData: '3Panel için yerel yedekleme dizinini yedekle',
        ...
        recoverHelper1: 'Kurtarma, Docker ve 3Panel servislerinin yeniden başlatılmasını gerektirir',
        recoverHelper2:
        ...
        rollback: 'Geri al',
        rollbackHelper:
            'Bu kurtarmayı geri almak, bu kurtarmadan gelen tüm dosyaları değiştirecek ve Docker ile 3Panel servislerinin yeniden başlatılmasını gerektirebilir. Devam etmek istiyor musunuz?',
        upgradeRecord: 'Yükseltme kaydı',
        upgrading: 'Yükseltiliyor, lütfen bekleyin...',
        upgradeHelper: 'Yükseltme, 3Panel servisinin yeniden başlatılmasını gerektirir. Devam etmek istiyor musunuz?',
        ...
        rollbackLocalHelper:
            'Birincil düğüm doğrudan geri almayı desteklemez. Lütfen geri almak için [3pctl restore] komutunu manuel olarak çalıştırın!',
    ...
    clean: {
        ...
        scanHelper: '3Panel çalışma zamanında üretilen gereksiz dosyaları kolayca temizleyin',
        clean: 'Şimdi temizle',
        reScan: 'Yeniden tara',
    ...
    ssl: {
        ...
        shell: 'Betik içeriği',
        shellHelper:
            'Betiğin varsayılan yürütme dizini, 3Panel kurulum dizinidir. Sertifika yerel dizine aktarılırsa, yürütme dizini sertifika aktarma dizini olacaktır. Varsayılan yürütme zaman aşımı 30 dakikadır.',
    ...
    firewall: {
        ...
        managedHelper: '3Panel tarafından oluşturulur ve yönetilir. Düzenlenebilir veya silinebilir.',
        adopted: 'Harici yönetilen',
        adoptedHelper: 'Önceden sistemde bulunan ve artık 3Panel tarafından yönetilen bir kuraldır.',
        external: 'Harici kural',
        externalHelper:
            'Sistemde bulunan ancak henüz 3Panel tarafından yönetilmeyen bir kuraldır. Gerektiğinde yönetime alınabilir.',
        ...
        adoptRuleConfirm: 'Devraldıktan sonra 3Panel bu mevcut kuralı yönetebilir ve silebilir. Devam edilsin mi?',
        ...
        scopeUnmanagedActive: 'Başka etkin kapsamlar algılandı: {0}. 3Panel bunların kurallarını değiştirmez.',
        ...
        dockerFirewallHelper: '3Panel konteyner portu korumasının nasıl yönetileceğini seçer.',
        ...
        ruleSyncDatabase: '3Panel veritabanı',
        ruleSyncDatabaseHelper:
            'Mevcut güvenlik duvarındaki yönetilen kuralları 3Panel veritabanı kurallarına göre eşitler ve uyumlu hale getirir. Eksik kurallar eklenir, fazla kurallar silinir.',
        ...
        resetDirectRulesHelper:
            '{0} içindeki 3Panel sistem güvenlik duvarı zincirlerini, çalışma zamanı kurallarını ve kalıcı dosyaları silin; veritabanı ilkelerini koruyun',
        ...
        cleanupForwardingBackendHelper:
            '{0} içindeki 3Panel bağlantı noktası yönlendirme çalışma zamanı kurallarını sıfırlayın: ilgili tüm kuralları ve zincirleri silip veritabanı verilerini koruyun',
        cleanupDockerBackendHelper:
            '{0} içindeki 3Panel Docker bağlantı noktası koruma çalışma zamanı kurallarını sıfırlayın: ilgili tüm kuralları ve zincirleri silip veritabanı verilerini koruyun',
        cleanupBeforeBackendSwitch:
            'Mevcut {0} arka ucu hâlâ 3Panel çalışma zamanı kuralları içeriyor. {1} arka ucuna geçmeden önce sıfırlayın. Sıfırlama yalnızca çalışma zamanı kurallarını temizler; veritabanı ilkeleri korunur ve geçişten sonra yeniden başlatılabilir veya eşitlenebilir.',
    ...
    tool: {
        supervisor: {
            ...
            initWarn:
                'Bu, ana yapılandırma dosyasındaki "[include]" bölümündeki "files" değerini değiştirecektir. Diğer yapılandırma dosyasının dizini şu şekilde olacaktır: "{3Panel kurulum dizini}/3panel/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'Kimlik sağlayıcı ile 3Panel arasındaki küçük zaman farklarına izin verir. Varsayılan 60 saniyeyi koruyun.',
                    ...
                    standardDiscoveryDesc: '3Panel uç noktaları ve yetenekleri keşfeder ve ham belgeyi saklamaz.',
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Bu özniteliği doğrulanmış SAML Assertion içinden okur ve 3Panel kullanıcı adına eşler.',
                    ...
                    syncLogoutHelper:
                        "3Panel'den veya kimlik sağlayıcıdan çıkış yapmak diğer taraftaki oturumu da kapatır.",
                    testBeforeBrowserTest:
                        'Tarayıcı oturum açma testine başlamadan önce mevcut yapılandırmayı test edin.',
                    testBeforeEnable:
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Kullanıcı arama tabanını ve filtreyi ayarlayın, ardından 3Panel name olarak kullanılan LDAP niteliğini eşleyin.',
                    ...
                    attributeMapTooltip: 'JSON, 3Panel name alanından bir LDAP özniteliğine eşleme.',
                    attributeMapHelper: '3Panel name alanına eşlenen LDAP niteliğini ayarlayın.',
                    advanced: 'Gelişmiş ayarlar',
                    ...
                    sync: {
                        ...
                        description:
                            "LDAP dizininin tamamını bir programa göre okuyun ve 3Panel'da içe aktarılan LDAP kullanıcılarını koruyun.",
                    ...
                    testLoginDesc:
                        'Yalnızca kimlik doğrulamayı test etmek için AD/LDAP kullanıcı kimlik bilgileriyle bağlantı kurun. 3Panel oturumu oluşturulmadı.',
        ...
        helper: {
            ...
            settingContent1: '3Panel giriş sayfasında özel bir hoş geldiniz mesajı ayarlayın.',
            ...
            appContent1: '3Panel sunucunuzu her zaman, her yerde kolayca yönetin.',
            ...
            vllmContent1:
                "Dağıtık vLLM örneklerini 3Panel'e entegre edin ve sürümleri, çalışma durumlarını ve çalışma dizinlerini merkezi olarak yönetin.",
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper:
                'Yalnızca `3panel-agent_v*_*` veya `3panel-v*-linux-*` kurulum paketleri desteklenir',
            ...
            panelExist:
                'Bu düğümde 3Panel V1 hizmeti çalıştığı algılandı. Lütfen eklemeden önce geçiş betiğini kullanarak V2’ye yükseltin.',
            coreExist:
            ...
            agentExist:
                'Bu düğümde 3panel-agent’ın zaten kurulu olduğu algılandı. Devam edilmesi mevcut verileri koruyacak ve yalnızca 3panel-agent hizmetini değiştirecektir.',
            agentNotExist:
            ...
            fixStatus:
                'Hizmetin çalıştığından emin olmak için "systemctl status 3panel-agent.service" komutunu çalıştırın.',
            ...
            uninstallHelper: 'Bu, düğümle ilgili tüm 3Panel verilerini silecektir. Dikkatli ilerleyin!',
        ...
        customApp: {
            ...
            imagePrefixHelper:
                'İşlev: Görüntü önekini özelleştirir ve compose dosyasındaki görüntü alanını değiştirir. Örneğin, görüntü öneki 3panel/custom olarak ayarlandığında, MaxKB için görüntü alanı 3panel/custom/maxkb:v1.10.0 olarak değişir',
