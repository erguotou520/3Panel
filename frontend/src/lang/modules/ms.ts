...
const message = {
    ...
    home: {
        ...
        restart_3panel: 'Mulakan semula panel',
    ...
    database: {
        ...
        supplementPasswordHelper: 'Hanya menyimpan kata laluan sedia ada ke 3Panel dan tidak mengubahnya dalam MySQL.',
        ...
        loadFromRemoteHelper:
            'Ini akan menyelaraskan pangkalan data, pengguna dan kebenaran dari pelayan ke 3Panel. Teruskan?',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: 'Model ini tidak dimuat turun melalui 3Panel; tiada log muat turun berkaitan.',
        ...
        benchmark: {
            ...
            tokenizerPlaceholder:
                'Pilih atau masukkan direktori tokenizer tempatan, cth. /opt/3panel/tokenizers/DeepSeek-V3',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Argumen ditambahkan pada arahan supergateway. Argumen pengangkutan, port, laluan dan protokol yang diurus oleh 3Panel tidak boleh diubah',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Dikesan bahawa bekas ini berasal dari Kedai Apl. Memadam bekas tidak akan mengalihnya sepenuhnya dari 3Panel. Untuk memadam sepenuhnya, sila pergi ke Kedai Apl -> menu 'Dipasang' atau 'Persekitaran Runtime'. Teruskan?",
        start: 'Mulakan',
        stop: 'Hentikan',
        restart: 'Mulakan semula',
        kill: 'Hentikan paksa',
        ...
        composeHelper:
            'Komposisi yang dicipta melalui editor atau templat 3Panel akan disimpan dalam direktori {0}/docker/compose.',
        ...
        composeDetailHelper: 'Komposisi dibuat di luar 3Panel. Operasi mula dan berhenti tidak disokong.',
        ...
        composeEnvHelper2:
            'Penyelarasan ini dibuat oleh Kedai Apl 3Panel. Sila ubah pembolehubah persekitaran dalam aplikasi yang dipasang.',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: 'Fail log yang diputar akan disandarkan ke direktori sandaran 3Panel.',
        ...
        logHelper1: '1. Log sistem 3Panel',
    ...
    file: {
        ...
        clashDidNotSupport: 'Nama fail dilarang mengandungi .3panel_clash',
        ...
        panelInstallDir: 'Direktori pemasangan 3Panel tidak boleh dipadamkan',
    ...
    setting: {
        ...
        timeZoneHelper:
            'Pengubahan zon waktu bergantung pada perkhidmatan sistem timedatectl. Berkuat kuasa selepas mulakan semula perkhidmatan 3Panel.',
        timeZoneCN: 'Beijing',
        timeZoneAM: 'Los Angeles',
        timeZoneNY: 'New York',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: 'Pengikatan domain 3Panel dikonfigurasi',
        ...
        bindDomainHelper: 'Selepas anda mengikat domain, hanya domain itu yang boleh mengakses perkhidmatan 3Panel.',
        bindDomainHelper1: 'Biarkan kosong untuk melumpuhkan ikatan nama domain.',
        bindDomainWarning:
            'Selepas ikatan domain, anda akan log keluar dan hanya boleh mengakses perkhidmatan 3Panel melalui nama domain yang ditentukan dalam tetapan. Adakah anda mahu meneruskan?',
        ...
        mfaTitleHelper:
            'Judul digunakan untuk membezakan hos 3Panel yang berbeza. Imbas lagi atau tambahkan kunci rahsia secara manual selepas anda mengubah judul.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'Aturan ini akan digunakan untuk memampatkan dan menyandarkan direktori data 3Panel semasa membuat snapshot. Secara lalai, fail soket diabaikan.',
        ignoreHelper1: 'Satu per baris. Contoh,\n*.log\n/opt/3panel/cache',
        panelInfo: 'Tulis maklumat asas 3Panel',
        panelBin: 'Sandarkan fail sistem 3Panel',
        daemonJson: 'Sandarkan fail konfigurasi Docker',
        appData: 'Sandarkan aplikasi yang dipasang dari 3Panel',
        panelData: 'Sandarkan direktori data 3Panel',
        backupData: 'Sandarkan direktori sandaran tempatan untuk 3Panel',
        ...
        recoverHelper1: 'Pemulihan memerlukan mulakan semula perkhidmatan Docker dan 3Panel',
        recoverHelper2:
        ...
        rollbackHelper:
            'Pulangkan semula pemulihan ini akan menggantikan semua fail dari pemulihan ini, dan mungkin memerlukan mulakan semula perkhidmatan Docker dan 3Panel. Adakah anda mahu meneruskan?',
        upgradeHelper: 'Kemas kini memerlukan mulakan semula perkhidmatan 3Panel. Adakah anda mahu meneruskan?',
        rollbackLocalHelper:
            'Nod utama tidak menyokong rollback secara langsung. Sila laksanakan arahan [3pctl restore] secara manual untuk rollback!',
    ...
    clean: {
        ...
        scanHelper: 'Bersihkan fail sampah dengan mudah yang dihasilkan semasa operasi 3Panel',
    ...
    ssl: {
        ...
        shellHelper:
            'Direktori pelaksanaan lalai skrip adalah direktori pemasangan 3Panel. Jika sijil ditolak ke direktori tempatan, direktori pelaksanaan akan menjadi direktori tolak sijil. Tamat masa pelaksanaan lalai ialah 30 minit.',
    ...
    firewall: {
        ...
        managedHelper: 'Dicipta dan diselenggara oleh 3Panel. Peraturan ini boleh diedit atau dipadam.',
        adopted: 'Luaran terurus',
        adoptedHelper: 'Peraturan sistem sedia ada yang kini diselenggara oleh 3Panel.',
        external: 'Peraturan luaran',
        externalHelper:
            'Peraturan sistem sedia ada yang belum diurus oleh 3Panel. Ia boleh diambil alih apabila diperlukan.',
        ...
        adoptRuleConfirm:
            'Selepas diambil alih, 3Panel boleh menyelenggara dan memadam peraturan sedia ada ini. Teruskan?',
        ...
        scopeUnmanagedActive: 'Skop aktif lain dikesan: {0}. 3Panel tidak akan mengubah peraturannya.',
        ...
        dockerFirewallHelper: 'Memilih cara 3Panel mengurus perlindungan port bekas.',
        ...
        ruleSyncDatabase: 'Pangkalan data 3Panel',
        ruleSyncDatabaseHelper:
            'Segerakkan dan selaraskan peraturan terurus dalam tembok api semasa berdasarkan peraturan pangkalan data 3Panel. Peraturan yang tiada akan ditambah dan peraturan berlebihan akan dipadam.',
        ...
        resetDirectRulesHelper:
            'Padam rantaian, peraturan masa jalan dan fail berterusan tembok api sistem 3Panel daripada {0}; dasar pangkalan data yang disimpan dikekalkan',
        ...
        cleanupForwardingBackendHelper:
            'Tetapkan semula peraturan masa jalan pemajuan port 3Panel dalam {0}: padam semua peraturan dan rantaian berkaitan sambil mengekalkan data pangkalan data',
        cleanupDockerBackendHelper:
            'Tetapkan semula peraturan masa jalan perlindungan port Docker 3Panel dalam {0}: padam semua peraturan dan rantaian berkaitan sambil mengekalkan data pangkalan data',
        cleanupBeforeBackendSwitch:
            'Bahagian belakang semasa {0} masih mengandungi peraturan masa jalan 3Panel. Tetapkan semula sebelum bertukar kepada {1}. Penetapan semula hanya membersihkan peraturan masa jalan; dasar pangkalan data dikekalkan dan boleh dimulakan atau disegerakkan selepas penukaran.',
    ...
    tool: {
        supervisor: {
            ...
            numprocs: 'Bil. proses',
            initWarn:
                'Ini akan mengubah nilai "files" dalam bahagian "[include]" dalam fail konfigurasi utama. Direktori fail konfigurasi lain akan menjadi: "{direktori pemasangan 3Panel}/3panel/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'Membenarkan sedikit perbezaan masa antara penyedia identiti dan 3Panel. Kekalkan nilai lalai 60 saat.',
                    ...
                    panelURLHelper:
                        'Masukkan alamat yang digunakan untuk mengakses 3Panel. Alamat ini digunakan untuk menjana URL panggil balik.',
                    panelURLInvalid: 'Masukkan asal yang mengandungi hanya skema, hos dan port pilihan.',
                    panelURLRequired: 'Masukkan 3Panel awam URL.',
                    ...
                    standardDiscoveryDesc:
                        '3Panel menemui titik akhir dan keupayaan dan tidak menyimpan dokumen mentah.',
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Membaca atribut ini daripada SAML Assertion yang disahkan dan memetakannya kepada nama pengguna 3Panel.',
                    ...
                    syncLogoutHelper:
                        'Log keluar daripada 3Panel atau penyedia identiti turut melog keluar bahagian yang lain.',
                    testBeforeBrowserTest: 'Uji konfigurasi semasa sebelum memulakan ujian log masuk penyemak imbas.',
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Tetapkan pangkalan carian dan penapis pengguna, kemudian petakan atribut LDAP yang digunakan sebagai 3Panel name.',
                    ...
                    attributeMapTooltip: 'Pemetaan JSON daripada medan 3Panel name kepada atribut LDAP.',
                    attributeMapHelper: 'Tetapkan atribut LDAP yang dipetakan ke medan 3Panel name.',
                    advanced: 'Tetapan lanjutan',
                    ...
                    sync: {
                        ...
                        description:
                            'Baca direktori LDAP penuh mengikut jadual dan kekalkan pengguna LDAP yang diimport dalam 3Panel.',
                    ...
                    testLoginDesc:
                        'Ikat dengan bukti kelayakan pengguna AD/LDAP untuk menguji pengesahan sahaja. Tiada sesi 3Panel dibuat.',
        ...
        helper: {
            ...
            settingContent1: 'Tetapkan mesej selamat datang tersuai pada halaman log masuk 3Panel.',
            ...
            appContent1: 'Uruskan pelayan 3Panel anda dengan mudah pada bila-bila masa dan di mana sahaja.',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper:
                'Hanya pakej pemasangan `3panel-agent_v*_*` atau `3panel-v*-linux-*` disokong',
            ...
            panelExist:
                'Mengesan nod ini sedang menjalankan perkhidmatan 3Panel V1. Sila naik taraf ke V2 menggunakan skrip migrasi sebelum menambah.',
            coreExist:
            ...
            agentExist:
                'Mengesan 3panel-agent telah dipasang pada nod ini. Penerusan akan mengekalkan data sedia ada dan hanya menggantikan perkhidmatan 3panel-agent.',
            agentNotExist:
            ...
            fixStatus:
                'Jalankan "systemctl status 3panel-agent.service" untuk memeriksa sama ada perkhidmatan sedang berjalan.',
            ...
            uninstallHelper: 'Ini akan memadamkan semua data berkaitan 3Panel bagi nod. Pilih dengan berhati-hati!',
        ...
        customApp: {
            ...
            imagePrefixHelper:
                'Fungsi: Sesuaikan awalan imej dan ubah medan imej dalam fail compose. Contohnya, apabila awalan imej ditetapkan kepada 3panel/custom, medan imej untuk MaxKB akan bertukar kepada 3panel/custom/maxkb:v1.10.0',
