...
const message = {
    ...
    home: {
        ...
        restart_3panel: 'Reiniciar painel',
    ...
    database: {
        ...
        supplementPasswordHelper: 'Apenas salva a senha existente no 3Panel; não altera a senha no MySQL.',
        ...
        loadFromRemoteHelper:
            'Isso sincronizará bancos de dados, usuários e autorizações do servidor com o 3Panel. Deseja continuar?',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: 'Este modelo não foi baixado pelo 3Panel; não há logs de download relacionados.',
        ...
        benchmark: {
            ...
            tokenizerPlaceholder:
                'Selecione ou informe um diretório local de tokenizer, ex.: /opt/3panel/tokenizers/DeepSeek-V3',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Os argumentos são adicionados ao comando supergateway. Os parâmetros de transporte, porta, caminho e protocolo gerenciados pelo 3Panel não podem ser alterados',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Detectado que o contêiner é da App Store. Excluir o contêiner não o removerá completamente do 3Panel. Para excluí-lo completamente, vá para a App Store -> menus 'Instalado' ou 'Ambiente de Execução'. Continuar?",
        start: 'Iniciar',
        stop: 'Parar',
        restart: 'Reiniciar',
        kill: 'Finalizar',
        ...
        composeHelper:
            'A composição criada através do editor ou template do 3Panel será salva no diretório {0}/docker/compose.',
        ...
        composeDetailHelper:
            'A composição foi criada externamente ao 3Panel. As operações de iniciar e parar não são suportadas.',
        ...
        composeEnvHelper2:
            'Esta orquestração foi criada pela Loja de Aplicativos 3Panel. Modifique as variáveis de ambiente nos aplicativos instalados.',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: 'Os arquivos de log rotacionados serão salvos no diretório de backup do 3Panel.',
        ...
        logHelper1: '1. Log do sistema 3Panel',
        cronSpecDoc:
    ...
    file: {
        ...
        clashDidNotSupport: 'Os nomes de arquivos são proibidos de conter .3panel_clash',
        ...
        panelInstallDir: 'O diretório de instalação do 3Panel não pode ser excluído',
    ...
    setting: {
        ...
        timeZoneHelper:
            'A modificação de fuso horário depende do serviço timedatectl do sistema. Entrará em vigor após reiniciar o serviço 3Panel.',
        timeZoneCN: 'Pequim',
        timeZoneAM: 'Los Angeles',
        timeZoneNY: 'Nova York',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: 'Vinculação de domínio do 3Panel configurada',
        ...
        bindDomainHelper: 'Após vincular o domínio, somente esse domínio poderá acessar o serviço 3Panel.',
        bindDomainHelper1: 'Deixe em branco para desabilitar o vínculo de domínio.',
        bindDomainWarning:
            'Após vincular o domínio, você será desconectado e poderá acessar o serviço 3Panel apenas através do domínio especificado nas configurações. Você deseja continuar?',
        ...
        mfaTitleHelper:
            'O título é usado para distinguir diferentes hosts do 3Panel. Escaneie novamente ou adicione manualmente a chave secreta após modificar o título.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'Esta regra será usada para comprimir e fazer backup do diretório de dados do 3Panel durante a criação do snapshot. Por padrão, arquivos de socket são ignorados.',
        ignoreHelper1: 'Um por linha. Exemplo,\n*.log\n/opt/3panel/cache',
        panelInfo: 'Escrever informações básicas do 3Panel',
        panelBin: 'Fazer backup dos arquivos do sistema 3Panel',
        daemonJson: 'Fazer backup do arquivo de configuração do Docker',
        appData: 'Fazer backup dos aplicativos instalados do 3Panel',
        panelData: 'Fazer backup do diretório de dados do 3Panel',
        backupData: 'Fazer backup do diretório de backup local do 3Panel',
        ...
        recoverHelper1: 'A recuperação requer reiniciar os serviços Docker e 3Panel',
        recoverHelper2:
        ...
        rollback: 'Rollback',
        rollbackHelper:
            'Reverter essa recuperação substituirá todos os arquivos dessa recuperação e pode exigir reiniciar os serviços Docker e 3Panel. Você deseja continuar?',
        upgradeHelper: 'A atualização requer reiniciar o serviço 3Panel. Você deseja continuar?',
        rollbackLocalHelper:
            'O nó principal não suporta rollback direto. Por favor, execute manualmente o comando [3pctl restore] para fazer o rollback!',
    ...
    clean: {
        ...
        scanHelper: 'Limpeza fácil de arquivos inúteis gerados durante a execução do 3Panel',
        clean: 'Limpar agora',
    ...
    ssl: {
        ...
        shellHelper:
            'O diretório padrão de execução do script é o diretório de instalação do 3Panel. Se um certificado for enviado para o diretório local, o diretório de execução será o diretório de envio do certificado. O tempo limite padrão de execução é de 30 minutos.',
    ...
    firewall: {
        ...
        managedHelper: 'Criada e mantida pelo 3Panel. Pode ser editada ou excluída.',
        adopted: 'Externa gerenciada',
        adoptedHelper: 'Uma regra existente do sistema que agora é mantida pelo 3Panel.',
        external: 'Regra externa',
        externalHelper:
            'Regra existente do sistema que ainda não é gerenciada pelo 3Panel. Pode ser adotada quando necessário.',
        ...
        adoptRuleConfirm: 'Depois disso, o 3Panel poderá manter e excluir esta regra existente. Continuar?',
        ...
        scopeUnmanagedActive: 'Outros escopos ativos foram detectados: {0}. O 3Panel não modificará suas regras.',
        ...
        dockerFirewallHelper: 'Seleciona como o 3Panel gerencia a proteção de portas de contêineres.',
        ...
        ruleSyncDatabase: 'Banco de dados do 3Panel',
        ruleSyncDatabaseHelper:
            'Sincroniza e ajusta as regras gerenciadas no firewall atual com base nas regras do banco de dados do 3Panel. As regras ausentes serão adicionadas e as excedentes serão removidas.',
        ...
        resetDirectRulesHelper:
            'Exclua de {0} as cadeias, regras em execução e arquivos persistentes do firewall do 3Panel; as políticas salvas no banco são mantidas',
        ...
        cleanupForwardingBackendHelper:
            'Redefina as regras de execução de encaminhamento de portas do 3Panel em {0}: exclua todas as regras e cadeias relacionadas e mantenha os dados do banco de dados',
        cleanupDockerBackendHelper:
            'Redefina as regras de execução de proteção de portas Docker do 3Panel em {0}: exclua todas as regras e cadeias relacionadas e mantenha os dados do banco de dados',
        cleanupBeforeBackendSwitch:
            'O backend atual {0} ainda contém regras de execução do 3Panel. Redefina-o antes de mudar para {1}. A redefinição remove apenas as regras de execução; as políticas do banco são mantidas e podem ser inicializadas ou sincronizadas após a troca.',
    ...
    tool: {
        supervisor: {
            ...
            initWarn:
                'Isso irá modificar o valor "files" na seção "[include"] do arquivo de configuração principal. O diretório de outros arquivos de configuração será: "{diretório de instalação do 3Panel}/3panel/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'Permite uma pequena diferença de horário entre o provedor de identidade e o 3Panel. Mantenha o padrão de 60 segundos.',
                    ...
                    standardDiscoveryDesc: '3Panel descobre endpoints e recursos e não armazena o documento bruto.',
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Lê este atributo da asserção SAML verificada e o mapeia para o nome de usuário do 3Panel.',
                    ...
                    syncLogoutHelper:
                        'Sair do 3Panel ou do provedor de identidade também encerra a sessão do outro lado.',
                    testBeforeBrowserTest:
                        'Teste a configuração atual antes de iniciar um teste de login do navegador.',
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Configure a base e o filtro de pesquisa e mapeie o atributo LDAP para o campo name do 3Panel.',
                    ...
                    attributeMapTooltip: 'Mapeamento JSON do campo name do 3Panel para um atributo LDAP.',
                    attributeMapHelper: 'Configure o atributo LDAP mapeado para o campo name do 3Panel.',
                    advanced: 'Configurações avançadas',
                    ...
                    sync: {
                        ...
                        description:
                            'Leia o diretório LDAP completo de acordo com uma programação e mantenha os usuários LDAP importados em 3Panel.',
                    ...
                    testLoginDesc:
                        'Vincule com uma credencial de usuário AD/LDAP apenas para testar a autenticação. Nenhuma sessão 3Panel é criada.',
        ...
        helper: {
            ...
            settingContent1: 'Defina uma mensagem de boas-vindas personalizada na página de login do 3Panel.',
            ...
            appContent1: 'Gerencie facilmente seu servidor 3Panel a qualquer hora e em qualquer lugar.',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper:
                'Somente pacotes de instalação `3panel-agent_v*_*` ou `3panel-v*-linux-*` são suportados',
            ...
            panelExist:
                'Detectado que este nó está executando o serviço 3Panel V1. Atualize para V2 usando o script de migração antes de adicionar.',
            coreExist:
            ...
            agentExist:
                'Detectado que 3panel-agent já está instalado neste nó. Continuar irá reter os dados existentes e apenas substituir o serviço 3panel-agent.',
            agentNotExist:
            ...
            fixStatus: 'Execute "systemctl status 3panel-agent.service" para verificar se o serviço está em execução.',
            ...
            uninstallHelper: 'Isso excluirá todos os dados relacionados ao 3Panel do nó. Escolha com cuidado!',
        ...
        customApp: {
            ...
            imagePrefixHelper:
                'Função: Personalize o prefixo da imagem e modifique o campo de imagem no arquivo compose. Por exemplo, quando o prefixo da imagem é configurado como 3panel/custom, o campo de imagem do MaxKB mudará para 3panel/custom/maxkb:v1.10.0',
