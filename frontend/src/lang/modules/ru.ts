...
const message = {
    ...
    license: {
        ...
        securityWarningContent:
            '3Panel должен запускаться пользователем с правами системного администратора. Неофициальные лицензии или измененные сборки могут привести к потере контроля над сервером, утечке данных и другим серьезным рискам безопасности. Получайте лицензии и установочные пакеты только через официальные каналы FIT2CLOUD.',
