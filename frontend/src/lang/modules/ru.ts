...
const message = {
    commons: {
        ...
        login: {
            ...
            licenseHelper: '<Лицензионное соглашение GPLv3>',
            errorAgree: 'Нажмите, чтобы согласиться с Лицензией программного обеспечения сообщества',
            logout: 'Выход',
            agreeTitle: 'Соглашение',
            agreeContent:
                'Для лучшей защиты ваших законных прав и интересов, пожалуйста, прочитайте и согласитесь со следующим соглашением &laquo; <a href = "https://www.gnu.org/licenses/gpl-3.0.html" target = "_blank" > Лицензионное соглашение GPLv3 </a> &raquo;',
    ...
    home: {
        ...
        restart_3panel: 'Перезапустить панель',
    ...
    database: {
        ...
        supplementPasswordHelper: 'Сохраняет текущий пароль только в 3Panel и не изменяет пароль в MySQL.',
        ...
        loadFromRemoteHelper: 'Синхронизировать базы данных, пользователей и права доступа с сервера в 3Panel?',
    ...
    aiTools: {
        agents: {
            ...
            modelMetadata: 'Возможности модели',
            modelMetadataHelper:
                'Эти настройки применяются только к текущему экземпляру OpenClaw. Оставьте поля пустыми, чтобы использовать значения OpenClaw или поставщика.',
            inputModeAuto: 'Определять автоматически',
            inputModeText: 'Только текст',
            inputModeImage: 'Текст и изображения',
            contextWindow: 'Контекстное окно',
            useModelDefault: 'Использовать значение модели',
        ...
        model: {
            ...
            from_remote: 'Эта модель не была загружена через 3Panel, нет связанных журналов извлечения.',
            ...
            vllmDeployProfile: 'Модель развертывания',
        ...
        benchmark: {
            ...
            tokenizerPlaceholder:
                'Выберите или введите локальный каталог токенизатора, например /opt/3panel/tokenizers/DeepSeek-V3',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Аргументы добавляются к команде supergateway. Параметры транспорта, порта, пути и протокола, управляемые 3Panel, изменить нельзя',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Обнаружено, что контейнер создан из Магазина приложений. Удаление контейнера не удалит его полностью из 3Panel. Для полного удаления перейдите в Магазин приложений -> меню 'Установленные' или 'Среда выполнения'. Продолжить?",
        start: 'Запустить',
        stop: 'Остановить',
        restart: 'Перезапустить',
        kill: 'Завершить',
        ...
        composeHelper:
            'Композиция, созданная через редактор 3Panel или шаблон, будет сохранена в директории {0}/docker/compose.',
        ...
        composeDetailHelper: 'Compose создан вне 3Panel. Операции запуска и остановки не поддерживаются.',
        ...
        composeEnvHelper2:
            'Эта оркестрация создана Магазином приложений 3Panel. Измените переменные среды в установленных приложениях.',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: 'Ротированные файлы логов будут сохранены в директории резервных копий 3Panel.',
        ...
        logHelper1: '1. Системный лог 3Panel',
    ...
    file: {
        ...
        clashDidNotSupport: 'Имена файлов не должны содержать .3panel_clash',
        ...
        panelInstallDir: 'Директорию установки 3Panel нельзя удалить',
    ...
    setting: {
        ...
        timeZoneHelper:
            'Изменение часового пояса зависит от системной службы timedatectl. Вступит в силу после перезапуска службы 3Panel.',
        timeZoneCN: 'Пекин',
        timeZoneAM: 'Лос-Анджелес',
        timeZoneNY: 'Нью-Йорк',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: 'Настроена привязка домена 3Panel',
        ...
        bindDomainHelper: 'После привязки домена только этот домен сможет получить доступ к службе 3Panel.',
        bindDomainHelper1: 'Оставьте пустым, чтобы отключить привязку доменного имени.',
        bindDomainWarning:
            'После привязки домена вы будете выходить из системы и сможете получить доступ к службе 3Panel только через указанное в настройках доменное имя. Хотите продолжить?',
        ...
        mfaTitleHelper:
            'Заголовок используется для различения разных хостов 3Panel. Отсканируйте снова или вручную добавьте секретный ключ после изменения заголовка.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'Это правило будет использоваться для сжатия и резервного копирования директории данных 3Panel при создании снапшота. По умолчанию игнорируются файлы сокетов.',
        ignoreHelper1: 'По одному в строке. Например,\n*.log\n/opt/3panel/cache',
        panelInfo: 'Записать базовую информацию 3Panel',
        panelBin: 'Резервное копирование системных файлов 3Panel',
        daemonJson: 'Резервное копирование конфигурационного файла Docker',
        appData: 'Резервное копирование установленных приложений из 3Panel',
        panelData: 'Резервное копирование директории данных 3Panel',
        backupData: 'Резервное копирование локальной директории резервных копий для 3Panel',
        ...
        recoverHelper1: 'Восстановление требует перезапуска служб Docker и 3Panel',
        recoverHelper2:
        ...
        rollback: 'Откатить',
        rollbackHelper:
            'Откат этого восстановления заменит все файлы из этого восстановления и может потребовать перезапуска служб Docker и 3Panel. Хотите продолжить?',
        upgradeHelper: 'Обновление требует перезапуска службы 3Panel. Хотите продолжить?',
        rollbackLocalHelper:
            'Основной узел не поддерживает прямой откат. Пожалуйста, вручную выполните команду [3pctl restore] для отката!',
    ...
    license: {
        ...
        securityWarningContent:
            '3Panel должен запускаться пользователем с правами системного администратора. Неофициальные лицензии или измененные сборки могут привести к потере контроля над сервером, утечке данных и другим серьезным рискам безопасности. Получайте лицензии и установочные пакеты только через официальные каналы.',
        ...
        vm: 'Перейдите на коммерческую версию, чтобы управлять виртуальными машинами, образами, шаблонами, виртуальными сетями и ресурсами хранения в 3Panel.',
        node: 'Обновление до коммерческой редакции позволяет управлять несколькими серверами Linux с помощью 3Panel.',
        nodeApp:
        ...
        vllm: 'Обновите до коммерческой версии, чтобы централизованно управлять сервисами vLLM в 3Panel: развертыванием, настройкой, жизненным циклом и отслеживанием задач.',
        'model-downloader':
    ...
    clean: {
        ...
        scanHelper: 'Легко очищайте мусорные файлы, созданные во время работы 3Panel',
    ...
    ssl: {
        ...
        shellHelper:
            'Директория выполнения скрипта по умолчанию - директория установки 3Panel. Если сертификат отправляется в локальную директорию, директорией выполнения будет директория отправки сертификата. Тайм-аут выполнения по умолчанию - 30 минут.',
    ...
    firewall: {
        ...
        managedHelper: 'Создано и поддерживается 3Panel. Правило можно изменить или удалить.',
        adopted: 'Внешнее под управлением',
        adoptedHelper: 'Существующее системное правило, которое теперь поддерживается 3Panel.',
        external: 'Внешнее правило',
        externalHelper:
            'Существующее системное правило, которое пока не управляется 3Panel. При необходимости его можно принять под управление.',
        ...
        adoptRuleConfirm: 'После этого 3Panel сможет обслуживать и удалять существующее правило. Продолжить?',
        ...
        scopeUnmanagedActive: 'Обнаружены другие активные области: {0}. 3Panel не будет изменять их правила.',
        ...
        dockerFirewallHelper: 'Выбирает способ управления защитой портов контейнеров в 3Panel.',
        ...
        ruleSyncDatabase: 'База данных 3Panel',
        ruleSyncDatabaseHelper:
            'Синхронизирует и приводит управляемые правила текущего межсетевого экрана в соответствие с правилами из базы данных 3Panel. Недостающие правила будут добавлены, а лишние — удалены.',
        ...
        resetDirectRulesHelper:
            'Удалить из {0} системные цепочки, действующие правила и постоянные файлы 3Panel; политики в базе данных сохраняются',
        ...
        cleanupForwardingBackendHelper:
            'Сбросить правила времени выполнения переадресации портов 3Panel в {0}: удалить все связанные правила и цепочки, сохранив данные в базе данных',
        cleanupDockerBackendHelper:
            'Сбросить правила времени выполнения защиты портов Docker 3Panel в {0}: удалить все связанные правила и цепочки, сохранив данные в базе данных',
        cleanupBeforeBackendSwitch:
            'Текущий бэкенд {0} всё ещё содержит правила времени выполнения 3Panel. Сбросьте его перед переключением на {1}. Сброс удаляет только правила времени выполнения; политики базы данных сохраняются и после переключения могут быть повторно инициализированы или синхронизированы.',
        ...
        dockerTrafficPathReason: {
            nat_inspect_failed:
                'Не удалось прочитать правила NAT Docker. Проверьте команды и права межсетевого экрана, затем обновите страницу.',
            proxy_inspect_failed:
                'Не удалось проверить процессы docker-proxy. Проверьте доступ к информации о системных процессах, затем обновите страницу.',
            nat_chain_unreachable:
                'Правило перенаправления Docker для этого порта найдено, но входная цепочка NAT не активна. Проверьте правила Docker или перезапустите Docker, затем обновите страницу.',
            no_matching_path:
    ...
    runtime: {
        ...
        envImportError: 'Строка {0}: {1}',
        envInvalidAssignment: 'Ожидается корректное присваивание NAME=value',
        envUnclosedQuote: 'Незакрытая кавычка',
        envUnexpectedText: 'Лишний текст после закрывающей кавычки',
        runtime: 'Среда выполнения',
    ...
    tool: {
        supervisor: {
            ...
            initWarn:
                'Это изменит значение "files" в секции "[include"] в основном конфигурационном файле. Директория других конфигурационных файлов будет: "{директория установки 3Panel}/3panel/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'Допускает небольшую разницу времени между поставщиком удостоверений и 3Panel. Оставьте значение по умолчанию 60 секунд.',
                    ...
                    panelURL: '3Panel общедоступный URL',
                    panelURLHTTPWarning:
                        'HTTP не ​​защищает ответ авторизации. Используйте его только в изолированной частной среде, разрешенной Provider.',
                    panelURLHelper:
                        'Укажите адрес, по которому пользователи открывают 3Panel. Он используется для формирования URL обратного вызова.',
                    panelURLInvalid: 'Введите источник, содержащий только схему, хост и дополнительный порт.',
                    panelURLRequired: 'Введите общедоступный 3Panel URL.',
                    ...
                    standardDiscoveryDesc:
                        '3Panel обнаруживает конечные точки и возможности и не сохраняет необработанный документ.',
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Считывает этот атрибут из проверенного SAML Assertion и сопоставляет его с именем пользователя 3Panel.',
                    ...
                    syncLogoutHelper: 'Выход из 3Panel или IdP также завершает сеанс на другой стороне.',
                    testBeforeBrowserTest: 'Проверьте текущую конфигурацию перед запуском проверки входа в браузер.',
                    testBeforeEnable:
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Установите базу поиска пользователей и фильтр, затем сопоставьте атрибут LDAP, используемый как 3Panel name.',
                    ...
                    attributeMapTooltip: 'Сопоставление JSON поля 3Panel name с атрибутом LDAP.',
                    attributeMapHelper: 'Установите атрибут LDAP, сопоставленный с полем 3Panel name.',
                    advanced: 'Расширенные настройки',
                    ...
                    sync: {
                        ...
                        description:
                            'Чтение полного каталога LDAP по расписанию и поддержка импортированных пользователей LDAP в 3Panel.',
                    ...
                    testLoginDesc:
                        'Привяжите учетные данные пользователя AD/LDAP только для проверки аутентификации. Сеанс 3Panel не создается.',
        ...
        helper: {
            ...
            settingContent1: 'Установите пользовательское приветственное сообщение на странице входа в 3Panel.',
            ...
            vmTitle1: 'Виртуальные машины',
            vmContent1:
                'Создавайте виртуальные машины, управляйте ими, отслеживайте состояние и настраивайте выделение ресурсов.',
            vmTitle2: 'Образы и шаблоны',
            vmContent2: 'Управляйте ISO-образами и шаблонами для удобного создания виртуальных машин.',
            vmTitle3: 'Виртуальные сети',
            vmContent3: 'Управляйте виртуальными сетями и настраивайте сетевые подключения виртуальных машин.',
            vmTitle4: 'Пулы хранения',
            vmContent4: 'Управляйте пулами хранения и выделяйте ресурсы хранения виртуальным машинам.',
            ...
            appContent1: 'Легко управляйте сервером 3Panel в любое время и в любом месте.',
            ...
            vllmContent1:
                'Интегрируйте распределённые экземпляры vLLM в 3Panel и централизованно отслеживайте версии, состояние работы и рабочие каталоги.',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper:
                'Поддерживаются только установочные пакеты `3panel-agent_v*_*` или `3panel-v*-linux-*`',
            ...
            panelExist:
                'Обнаружено, что на этом узле работает служба 3Panel V1. Перед добавлением обновите до V2 с помощью скрипта миграции.',
            coreExist:
            ...
            agentExist:
                'Обнаружено, что 3panel-agent уже установлен на этом узле. Продолжение сохранит существующие данные и заменит только службу 3panel-agent.',
            agentNotExist:
                'Обнаружено, что на этом узле не установлен 3panel-agent, поэтому информацию об узле нельзя редактировать напрямую. Удалите его и добавьте снова.',
            oldDataExist:
                'Обнаружены исторические данные 3Panel V2 на этом узле. Текущие настройки будут перезаписаны следующей информацией:',
            ...
            fixStatus: 'Запустите "systemctl status 3panel-agent.service", чтобы проверить, запущена ли служба.',
            ...
            uninstallHelper: 'Это удалит все данные 3Panel, связанные с узлом. Выбирайте осторожно!',
        ...
        customApp: {
            ...
            imagePrefixHelper:
                'Функция: Настройка префикса образа и изменение поля образа в файле compose. Например, если префикс образа установлен как 3panel/custom, поле образа для MaxKB изменится на 3panel/custom/maxkb:v1.10.0',
