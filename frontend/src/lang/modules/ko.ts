...
const message = {
    ...
    database: {
        ...
        supplementPasswordHelper: '기존 비밀번호를 3Panel에만 저장하며 MySQL 비밀번호는 변경하지 않습니다.',
        pgBindHelper:
            '이 작업은 새 사용자를 생성하여 대상 데이터베이스에 바인딩하는 데 사용됩니다. 현재 데이터베이스에 이미 존재하는 사용자 선택은 지원되지 않습니다.',
        pgSuperUser: '슈퍼 사용자',
        loadFromRemoteHelper: '서버의 데이터베이스, 사용자 및 권한 정보를 3Panel로 동기화합니다. 계속하시겠습니까?',
    ...
    aiTools: {
        agents: {
            ...
            modelMetadata: '모델 기능 설정',
            modelMetadataHelper:
                '이 설정은 현재 OpenClaw에만 적용됩니다. 비워 두면 OpenClaw 또는 공급자의 기본값을 사용합니다.',
            inputModeAuto: '자동 감지',
            inputModeText: '텍스트만',
            inputModeImage: '텍스트 및 이미지',
            contextWindow: '컨텍스트 창',
            useModelDefault: '모델 기본값 사용',
            reasoning: '추론 모델',
            verified: '검증됨',
        ...
        model: {
            ...
            from_remote: '이 모델은 3Panel을 통해 다운로드되지 않았으며 관련 풀 로그가 없습니다.',
        ...
        benchmark: {
            ...
            tokenizerPlaceholder:
                '로컬 토크나이저 디렉터리를 선택하거나 입력하세요. 예: /opt/3panel/tokenizers/DeepSeek-V3',
            runConfig: '실행 구성',
            rawResult: '원시 결과',
            resultMetrics: '결과 지표',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                '인수는 supergateway 시작 명령에 추가됩니다. 3Panel에서 관리하는 전송, 포트, 경로 및 프로토콜 인수는 변경할 수 없습니다',
    ...
    container: {
        ...
        containerDeleteHelper:
            "컨테이너가 앱 스토어에서 생성된 것으로 감지되었습니다. 컨테이너를 삭제해도 3Panel에서 완전히 제거되지 않습니다. 완전히 삭제하려면 앱 스토어 -> '설치됨' 또는 '런타임 환경' 메뉴로 이동하여 작업하십시오. 계속하시겠습니까?",
        start: '시작',
        stop: '중지',
        restart: '재시작',
        kill: '강제 종료',
        ...
        composeHelper: '3Panel 에디터나 템플릿을 통해 생성된 컴포지션은 {0}/docker/compose 디렉토리에 저장됩니다.',
        deleteFile: '파일 삭제',
        deleteComposeHelper:
        ...
        exited: '종료됨',
        running: '실행 중 ( {0} / {1} )',
        composeDetailHelper: '이 컴포즈는 3Panel 외부에서 생성되었습니다. 시작 및 중지 작업은 지원되지 않습니다.',
        composeOperatorHelper: '{1} 작업이 {0}에서 수행됩니다. 계속 하시겠습니까?',
        composeDownHelper:
            '이 작업은 {0} 컴포즈 아래의 모든 컨테이너와 네트워크를 중지하고 제거합니다. 계속 하시겠습니까?',
        composeEnvHelper2:
            '이 오케스트레이션은 3Panel 앱 스토어에서 생성되었습니다. 설치된 애플리케이션에서 환경 변수를 수정하세요.',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: '회전된 로그 파일은 3Panel 의 백업 디렉토리로 백업됩니다.',
    ...
    terminal: {
        ...
        sessionRuleDisableShortcut: '「터미널 - 설정」에서 터미널 바로가기를 비활성화할 수 있습니다.',
        minimize: '최소화',
    ...
    file: {
        ...
        clashDidNotSupport: '파일 이름에 .3panel_clash 를 포함할 수 없습니다.',
        ...
        panelInstallDir: '3Panel 설치 디렉터리는 삭제할 수 없습니다.',
        wgetTask: '다운로드 작업',
    ...
    setting: {
        ...
        timeZoneHelper: '시간대 변경은 시스템 timedatectl 서비스에 따라 작동하며, 3Panel 서비스 재시작 후 적용됩니다.',
        timeZoneCN: '베이징',
        timeZoneAM: '로스앤젤레스',
        timeZoneNY: '뉴욕',
        ntpALi: '알리바바',
        ...
        passkeyPrereqBindDomain: '3Panel 도메인 바인딩 구성됨',
        ...
        bindDomainHelper: '도메인을 바인딩한 후에는 해당 도메인을 통해서만 3Panel 서비스에 접근할 수 있습니다.',
        bindDomainHelper1: '공백으로 남기면 도메인 이름 바인딩이 비활성화됩니다.',
        bindDomainWarning:
            '도메인 바인딩 후 로그아웃되며 설정에 지정된 도메인 이름을 통해서만 3Panel 서비스에 접근할 수 있습니다. 계속하시겠습니까?',
        allowIPs: '허가된 IP',
        ...
        mfaInterval: '갱신 간격(초)',
        mfaTitleHelper:
            '제목은 다른 3Panel 호스트를 구별하는 데 사용됩니다. 제목을 수정한 후 다시 스캔하거나 비밀키를 수동으로 추가하세요.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            '이 규칙은 스냅샷을 생성할 때 3Panel 데이터 디렉토리를 압축하고 백업하는 데 사용됩니다. 기본적으로 소켓 파일은 무시됩니다.',
        ignoreHelper1: '한 줄에 하나씩 입력하세요. 예:\n*.log\n/opt/3panel/cache',
        panelInfo: '3Panel 기본 정보 쓰기',
        panelBin: '3Panel 시스템 파일 백업',
        daemonJson: 'Docker 구성 파일 백업',
        appData: '3Panel 에서 설치된 앱 백업',
        panelData: '3Panel 데이터 디렉토리 백업',
        backupData: '3Panel 의 로컬 백업 디렉토리 백업',
        compress: '스냅샷 파일 생성',
        upload: '스냅샷 파일 업로드',
        ...
        recoverHelper1: '복구에는 Docker 및 3Panel 서비스를 재시작해야 합니다.',
        ...
        rollback: '롤백',
        rollbackHelper:
            '이 복구를 롤백하면 해당 복구의 모든 파일이 대체되며 Docker 및 3Panel 서비스를 재시작해야 할 수 있습니다. 계속하시겠습니까?',
        upgradeHelper: '업그레이드에는 3Panel 서비스를 재시작해야 합니다. 계속하시겠습니까?',
        rollbackLocalHelper:
            '마스터 노드는 직접 롤백을 지원하지 않습니다. 수동으로 [3pctl restore] 명령어를 실행하여 롤백하세요!',
    ...
    license: {
        ...
        vm: '상용 버전으로 업그레이드하면 3Panel에서 가상 머신, 이미지와 템플릿, 가상 네트워크 및 스토리지 리소스를 통합 관리할 수 있습니다.',
        node: '상용 버전으로 업그레이드하면 3Panel에서 여러 Linux 서버를 관리할 수 있습니다.',
        nodeApp:
    ...
    clean: {
        scan: '스캔 시작',
        scanHelper: '3Panel 실행 중에 생성된 불필요한 파일을 쉽게 정리합니다.',
        clean: '지금 정리',
        reScan: '다시 스캔',
    ...
    ssl: {
        ...
        shell: '스크립트 내용',
        shellHelper:
            '스크립트의 기본 실행 디렉토리는 3Panel 설치 디렉토리입니다. 인증서가 로컬 디렉토리에 푸시되는 경우 실행 디렉토리는 인증서 푸시 디렉토리가 됩니다. 기본 실행 제한 시간은 30분입니다.',
    ...
    firewall: {
        ...
        unUsed: '사용 안 함',
        managed: '패널 생성',
        managedHelper: '3Panel에서 생성하고 관리하는 규칙으로 편집하거나 삭제할 수 있습니다.',
        adopted: '외부 규칙 관리',
        adoptedHelper: '기존 시스템 규칙을 현재 3Panel에서 관리하고 있습니다.',
        external: '외부 규칙',
        externalHelper:
            '시스템에 존재하지만 아직 3Panel에서 관리하지 않는 규칙이며 필요할 때 관리 대상으로 전환할 수 있습니다.',
        protected: '시스템 보호',
        ...
        adoptRuleConfirm:
            '관리 대상으로 전환하면 3Panel이 이 기존 규칙을 유지하고 삭제할 수 있습니다. 계속하시겠습니까?',
        ...
        scopeUnmanagedActive: '다른 활성 범위가 감지되었습니다: {0}. 3Panel은 해당 규칙을 변경하지 않습니다.',
        ...
        dockerFirewallHelper: '3Panel 컨테이너 포트 보호 관리 방식을 선택합니다.',
        ...
        ruleSyncDatabase: '3Panel 데이터베이스',
        ruleSyncDatabaseHelper:
            '3Panel 데이터베이스 규칙을 기준으로 현재 방화벽의 관리 규칙을 동기화하고 조정합니다. 누락된 규칙은 추가되고 불필요한 규칙은 삭제됩니다.',
        ...
        resetDirectRulesHelper:
            '{0}에서 3Panel 시스템 방화벽 체인, 실행 규칙 및 영구 파일을 삭제하고 데이터베이스 정책은 유지합니다',
        ...
        cleanupForwardingBackendHelper:
            '{0}의 3Panel 포트 전달 런타임 규칙을 재설정합니다. 관련 규칙과 체인을 모두 삭제하고 데이터베이스 데이터는 유지합니다',
        cleanupDockerBackendHelper:
            '{0}의 3Panel Docker 포트 보호 런타임 규칙을 재설정합니다. 관련 규칙과 체인을 모두 삭제하고 데이터베이스 데이터는 유지합니다',
        cleanupBeforeBackendSwitch:
            '현재 {0} 백엔드에 3Panel 런타임 규칙이 남아 있습니다. {1}(으)로 전환하기 전에 먼저 재설정하세요. 재설정은 런타임 규칙만 정리하며 데이터베이스 정책은 유지됩니다. 전환 후 다시 초기화하거나 동기화할 수 있습니다.',
        cleanupAction: '재설정',
        backendSwitchNotice:
    ...
    tool: {
        supervisor: {
            ...
            numprocs: '프로세스 수',
            initWarn:
                '이 작업은 주 설정 파일의 "[include]" 섹션에 있는 "files" 값을 수정합니다. 다른 설정 파일의 디렉토리는 "{3Panel 설치 디렉토리}/3panel/tools/supervisord/supervisor.d/"입니다.',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'ID 공급자와 3Panel 사이의 약간의 시간 차이를 허용합니다. 기본값인 60초를 유지하세요.',
                    ...
                    panelURL: '3Panel 공개 URL',
                    panelURLHTTPWarning:
                        'HTTP는 인가 응답을 보호하지 않습니다. 공급자가 허용한 격리된 사설 환경에서만 사용하세요.',
                    panelURLHelper: '사용자가 3Panel에 접속하는 주소를 입력하세요. 콜백 URL 생성에 사용됩니다.',
                    panelURLInvalid: '구성표, 호스트 및 선택적 포트만 포함하는 원본을 입력하세요.',
                    panelURLRequired: '3Panel 공개 URL을 입력하세요.',
                    ...
                    standardDiscoveryDesc: '3Panel은 엔드포인트와 기능을 검색하지만 원시 문서는 저장하지 않습니다.',
                    standardMode: '표준 모드',
                ...
                saml2: {
                    ...
                    nameAttributeHelper: '검증된 SAML Assertion에서 이 속성을 읽어 3Panel 사용자 이름에 매핑합니다.',
                    ...
                    syncLogout: '동기화 로그아웃',
                    syncLogoutHelper: '3Panel 또는 IdP에서 로그아웃하면 다른 쪽에서도 함께 로그아웃됩니다.',
                    testBeforeBrowserTest: '브라우저 테스트 로그인을 시작하기 전에 현재 구성을 테스트하세요.',
                ...
                ldap: {
                    ...
                    userSearch: '사용자 검색',
                    userSearchDesc:
                        '사용자 검색 기반 및 필터를 설정한 다음 3Panel name로 사용되는 LDAP 속성을 매핑합니다.',
                    userFilter: '사용자 필터',
                    userFilterTooltip:
                        '%(user)s를 이스케이프된 사용자 이름으로 바꾸거나 전체 디렉터리 읽기를 위해 *로 바꿉니다.',
                    userFilterHelper: '사용자 이름은 LDAP 필터에 삽입되기 전에 이스케이프됩니다.',
                    attributeMap: '속성 매핑',
                    attributeMapTooltip: '3Panel name 필드에서 LDAP 속성으로 매핑되는 JSON.',
                    attributeMapHelper: '3Panel name 필드에 매핑된 LDAP 속성을 설정합니다.',
                    advanced: '고급 설정',
                    ...
                    sync: {
                        title: '예약된 동기화',
                        description: '일정에 따라 전체 LDAP 디렉터리를 읽고 가져온 LDAP 사용자를 3Panel에 유지합니다.',
                        enable: '일정 활성화',
                    ...
                    testLoginDesc:
                        '인증을 테스트하기 위해 AD/LDAP 사용자 자격 증명으로 바인딩합니다. 3Panel 세션이 생성되지 않습니다.',
        ...
        helper: {
            ...
            settingContent1: '3Panel 로그인 페이지에 사용자 정의 환영 메시지를 설정합니다.',
            ...
            appTitle1: '유연한 패널 관리',
            appContent1: '언제 어디서나 3Panel 서버를 쉽게 관리하세요.',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper: '`3panel-agent_v*_*` 또는 `3panel-v*-linux-*` 설치 패키지만 지원됩니다',
            ...
            panelExist:
                '이 노드에서 3Panel V1 서비스가 실행 중인 것으로 감지되었습니다. 추가 전에 마이그레이션 스크립트로 V2로 업그레이드하십시오.',
            coreExist:
                '현재 노드가 마스터 노드로 활성화되어 있어 슬레이브 노드로 직접 추가할 수 없습니다. 추가하기 전에 먼저 슬레이브 노드로 다운그레이드하십시오. 자세한 내용은 문서를 참조하십시오.',
            agentExist:
                '이 노드에 3panel-agent가 이미 설치되어 있는 것으로 감지되었습니다. 계속하면 기존 데이터를 유지하고 3panel-agent 서비스만 교체됩니다.',
            agentNotExist:
            ...
            fixStatus: '"systemctl status 3panel-agent.service"를 실행하여 서비스가 실행 중인지 확인합니다.',
            ...
            uninstall: '노드 데이터 삭제',
            uninstallHelper: '이 작업은 노드의 모든 3Panel 관련 데이터를 삭제합니다. 신중하게 선택하세요!',
            baseDir: '설치 디렉토리',
        ...
        customApp: {
            ...
            imagePrefix: '이미지 접두사',
            imagePrefixHelper:
                '기능: 이미지 접두사를 사용자 정의하고 compose 파일의 이미지 필드를 수정합니다. 예를 들어 이미지 접두사를 3panel/custom으로 설정하면 MaxKB의 이미지 필드는 3panel/custom/maxkb:v1.10.0으로 변경됩니다',
