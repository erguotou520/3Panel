...
const defaultLoginImage = new URL('@/assets/images/3panel-login.svg', import.meta.url).href;
const defaultEnterpriseLoginImage = new URL('@/assets/images/3panel-login-enterprise.svg', import.meta.url).href;
