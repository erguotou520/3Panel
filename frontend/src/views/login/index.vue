...
const defaultLoginImage = new URL('@/assets/images/3panel-login.jpg', import.meta.url).href;
const defaultEnterpriseLoginImage = new URL('@/assets/images/3panel-login-enterprise.png', import.meta.url).href;
