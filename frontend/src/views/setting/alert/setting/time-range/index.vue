                        ...
                        <template #left-footer>
                            <el-form-item prop="noticeTimeRange">
                                ...
                                <span class="input-help ml-2">
                                    {{
                                        $t('alert.sendTimeRangeHelper', [
                                            $t('alert.noticeAlert').toLowerCase(),
                                        ])
                                    }}
                                </span>
                            </el-form-item>
                        ...
                        <template #right-footer>
                            <el-form-item prop="resourceTimeRange">
                                ...
                                <span class="input-help ml-2">
                                    {{
                                        $t('alert.sendTimeRangeHelper', [
                                            $t('alert.resourceAlert').toLowerCase(),
                                        ])
                                    }}
                                </span>
                            </el-form-item>
...
const generateData = (): Option[] => {
    const data: Option[] = [];
    data.push({ key: 'panelPwdEndTime', label: i18n.global.t('alert.panelPwdEndTime'), disabled: false });
    ...
    data.push({ key: 'nodeException', label: i18n.global.t('alert.nodeException'), disabled: false });
    ...
    data.push({ key: 'panelUpdate', label: i18n.global.t('alert.panelUpdate'), disabled: false });
    return data;
};
