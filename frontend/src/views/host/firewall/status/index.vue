...
const managedChainName = computed(() => (props.currentTab === 'forward' ? '3PANEL_FORWARD' : '3PANEL_BASIC'));
...
const onBind = async () => {
    ...
    await operateFilterChain('3PANEL_BASIC', 'bind-base');
    MsgSuccess(i18n.global.t('commons.msg.operationSuccess'));
    await loadBaseInfo(true);
};
...
const onUnBind = async () => {
    ...
    await operateFilterChain('3PANEL_BASIC', 'unbind-base');
    MsgSuccess(i18n.global.t('commons.msg.operationSuccess'));
    await loadBaseInfo(true);
};
