...
3Panel es un panel de control moderno y de código abierto basado en web para la gestión de servidores Linux.
...
Ejecute el siguiente script y siga las indicaciones para instalar 3Panel:

```bash
curl -sSL https://resource.3panel.pro/quick_start.sh -o quick_start.sh && bash quick_start.sh
```

Por favor, consulte nuestra [documentación](https://docs.3panel.pro/quick_start/) para más detalles.
