...
3Panel - это современная веб-панель управления Linux-серверами с открытым исходным кодом.

- **Эффективное управление**: Благодаря удобному веб-интерфейсу, 3Panel позволяет пользователям легко управлять своими Linux-серверами. Основные функции включают мониторинг хоста, управление файлами, администрирование баз данных и управление контейнерами.
- **Быстрое развертывание сайтов**: Благодаря глубокой интеграции с популярной системой создания сайтов WordPress, 3Panel упрощает процесс привязки домена и настройки SSL-сертификатов, все это достигается одним кликом.
- **Магазин приложений**: 3Panel предлагает широкий выбор качественных инструментов и приложений с открытым исходным кодом, обеспечивая простую установку и обновление для пользователей.
- **Безопасность и надежность**: Используя контейнеризацию и безопасные практики развертывания приложений, 3Panel минимизирует уязвимости. Безопасность дополнительно усиливается благодаря встроенному управлению межсетевым экраном и возможностям аудита логов.
...
Выполните скрипт ниже и следуйте инструкциям для установки 3Panel:

```bash
curl -sSL https://resource.3panel.pro/quick_start.sh -o quick_start.sh && bash quick_start.sh
```

Для получения дополнительной информации обратитесь к нашей [документации](https://docs.3panel.pro/quick_start/).

## Скриншот

![Интерфейс](https://resource.3panel.pro/img/3panel.png)

## История звезд

[![График истории звезд](https://api.star-history.com/svg?repos=3panel-dev/3panel&type=Date)](https://star-history.com/#3panel-dev/3panel&Date)
