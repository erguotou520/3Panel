<p align="center"><a href="https://3panel.cn"><img src="http://3panel.oss-cn-hangzhou.aliyuncs.com/img/3panel-logo.png" alt="3Panel" width="300" /></a></p>
> [!IMPORTANT]
...
<p align="center">
  ...
  <a href="https://github.com/3panel-dev/3panel"><img src="https://img.shields.io/github/stars/3panel-dev/3panel?color=%231890FF&style=flat-square" alt="GitHub Stars"></a>
  <a href="https://gitee.com/fit2cloud-feizhiyun/3Panel"><img src="https://gitee.com/fit2cloud-feizhiyun/3Panel/badge/star.svg?theme=gvp" alt="Gitee Stars"></a>
  <a href="https://gitcode.com/feizhiyun/3Panel"><img src="https://gitcode.com/feizhiyun/3Panel/star/badge.svg" alt="GitCode Stars"></a><br>
</p>
<p align="center">
...
[![Watch the video](https://resource.fit2cloud.com/3panel/img/overview_video.png)](https://www.bilibili.com/video/BV1Mt421n7LZ/)

------------------------------
## 什麼是 3Panel？

3Panel 是新一代的 Linux 伺服器運維管理面板。
...
```sh
curl -sSL https://resource.fit2cloud.com/3panel/package/quick_start.sh -o quick_start.sh && sudo bash quick_start.sh
```

如果是用於離線環境，推薦使用 [安裝包方式](https://3panel.cn/docs/installation/package_installation/) 進行安裝部署。

**學習資料**

- [線上文件](https://3panel.cn/docs/)
- [社區論壇](https://bbs.fit2cloud.com/c/1p/7)
- [如何加入微信交流群?](https://bbs.fit2cloud.com/t/topic/2147)

## 專業版

相比於社區版，3Panel 專業版為使用者提供了大量增強功能及技術支援服務，增強功能包括 WAF 增強、網站防篡改、網站監控、GPU 監控、黑金主題及自訂介面等。 [點擊查看專業版詳細介紹](https://www.lxware.cn/3panel)。
