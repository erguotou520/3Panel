...
import (
	...
	"github.com/3panel-dev/3panel/core/cmd/server/docs"
	"github.com/3panel-dev/3panel/core/cmd/server/web"
	"github.com/3panel-dev/3panel/core/global"
	"github.com/3panel-dev/3panel/core/i18n"
	"github.com/3panel-dev/3panel/core/init/swagger"
...
func Routers() *gin.Engine {
	...
	swaggerRouter := Router.Group("3panel")
...
func RegisterImages(rootRouter *gin.RouterGroup) {
	staticDir := filepath.Join(global.CONF.Base.InstallDir, "3panel/uploads/theme")
