...
func updateBindInfo(protocol string) error {
	if !isRoot() {
		fmt.Println(i18n.GetMsgWithMapForCmd("SudoHelper", map[string]interface{}{"cmd": "sudo 3pctl listen-ip ipv6"}))
		return nil
	}
