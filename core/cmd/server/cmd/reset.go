...
var resetMFACmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		i18n.UseI18nForCmd(language)
		if !isRoot() {
			fmt.Println(i18n.GetMsgWithMapForCmd("SudoHelper", map[string]interface{}{"cmd": "sudo 3pctl reset mfa"}))
			return nil
		}
...
var resetSSLCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		i18n.UseI18nForCmd(language)
		if !isRoot() {
			fmt.Println(i18n.GetMsgWithMapForCmd("SudoHelper", map[string]interface{}{"cmd": "sudo 3pctl reset https"}))
			return nil
		}
		db, err := loadDBConn("core.db")
		if err != nil {
...
var resetEntranceCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		i18n.UseI18nForCmd(language)
		if !isRoot() {
			fmt.Println(i18n.GetMsgWithMapForCmd("SudoHelper", map[string]interface{}{"cmd": "sudo 3pctl reset entrance"}))
			return nil
		}
		db, err := loadDBConn("core.db")
		if err != nil {
...
var resetBindIpsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		i18n.UseI18nForCmd(language)
		if !isRoot() {
			fmt.Println(i18n.GetMsgWithMapForCmd("SudoHelper", map[string]interface{}{"cmd": "sudo 3pctl reset ips"}))
			return nil
		}
		db, err := loadDBConn("core.db")
		if err != nil {
...
var resetDomainCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		i18n.UseI18nForCmd(language)
		if !isRoot() {
			fmt.Println(i18n.GetMsgWithMapForCmd("SudoHelper", map[string]interface{}{"cmd": "sudo 3pctl reset domain"}))
			return nil
		}
		db, err := loadDBConn("core.db")
		if err != nil {
...
var resetPasskeyCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		i18n.UseI18nForCmd(language)
		if !isRoot() {
			fmt.Println(i18n.GetMsgWithMapForCmd("SudoHelper", map[string]interface{}{"cmd": "sudo 3pctl reset passkey"}))
			return nil
		}
		db, err := loadDBConn("core.db")
		if err != nil {
...
func loadResetHelper() {
	...
	fmt.Println("\nUse \"3panel reset [command] --help\" for more information about a command.")
}
