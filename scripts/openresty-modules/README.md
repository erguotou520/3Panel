...
This script collects diagnostics from an installed 3Panel OpenResty instance.
...
```text
/opt/3panel/apps/openresty/openresty
```
...
Do not edit generated module state or managed config files while a 3Panel app
